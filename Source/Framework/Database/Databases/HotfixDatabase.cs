...
namespace Framework.Database
{
    public class HotfixDatabase : MySqlBase<HotfixStatements>
    {
        public override void PreparedStatements()
        {
            ...
            PrepareStatement(HotfixStatements.SEL_ACHIEVEMENT_MAX_ID, "SELECT MAX(ID) + 1 FROM achievement");
            ...
            PrepareStatement(HotfixStatements.SEL_ACHIEVEMENT_CATEGORY_MAX_ID, "SELECT MAX(ID) + 1 FROM achievement_category");
            ...
            PrepareStatement(HotfixStatements.SEL_ADVENTURE_JOURNAL_MAX_ID, "SELECT MAX(ID) + 1 FROM adventure_journal");
            ...
            PrepareStatement(HotfixStatements.SEL_ADVENTURE_MAP_POI_MAX_ID, "SELECT MAX(ID) + 1 FROM adventure_map_poi");
            ...
            PrepareStatement(HotfixStatements.SEL_ANIMATION_DATA_MAX_ID, "SELECT MAX(ID) + 1 FROM animation_data");
            ...
            PrepareStatement(HotfixStatements.SEL_ANIM_KIT, "SELECT ID, OneShotDuration, OneShotStopAnimKitID, LowDefAnimKitID FROM anim_kit" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_ANIM_KIT_MAX_ID, "SELECT MAX(ID) + 1 FROM anim_kit");
            ...
            PrepareStatement(HotfixStatements.SEL_AREA_GROUP_MEMBER_MAX_ID, "SELECT MAX(ID) + 1 FROM area_group_member");
            ...
            PrepareStatement(HotfixStatements.SEL_AREA_TABLE_MAX_ID, "SELECT MAX(ID) + 1 FROM area_table");
            ...
            PrepareStatement(HotfixStatements.SEL_AREA_TRIGGER_MAX_ID, "SELECT MAX(ID) + 1 FROM area_trigger");
            ...
            PrepareStatement(HotfixStatements.SEL_ARMOR_LOCATION, "SELECT ID, Clothmodifier, Leathermodifier, Chainmodifier, Platemodifier, Modifier FROM armor_location" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_ARMOR_LOCATION_MAX_ID, "SELECT MAX(ID) + 1 FROM armor_location");
            ...
            PrepareStatement(HotfixStatements.SEL_ARTIFACT_MAX_ID, "SELECT MAX(ID) + 1 FROM artifact");
            ...
            PrepareStatement(HotfixStatements.SEL_ARTIFACT_APPEARANCE, "SELECT Name, ID, ArtifactAppearanceSetID, DisplayIndex, UnlockPlayerConditionID, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_ARTIFACT_APPEARANCE_MAX_ID, "SELECT MAX(ID) + 1 FROM artifact_appearance");
            ...
            PrepareStatement(HotfixStatements.SEL_ARTIFACT_APPEARANCE_SET_MAX_ID, "SELECT MAX(ID) + 1 FROM artifact_appearance_set");
            ...
            PrepareStatement(HotfixStatements.SEL_ARTIFACT_CATEGORY_MAX_ID, "SELECT MAX(ID) + 1 FROM artifact_category");
            ...
            PrepareStatement(HotfixStatements.SEL_ARTIFACT_POWER_MAX_ID, "SELECT MAX(ID) + 1 FROM artifact_power");
            ...
            PrepareStatement(HotfixStatements.SEL_ARTIFACT_POWER_LINK_MAX_ID, "SELECT MAX(ID) + 1 FROM artifact_power_link");
            ...
            PrepareStatement(HotfixStatements.SEL_ARTIFACT_POWER_PICKER_MAX_ID, "SELECT MAX(ID) + 1 FROM artifact_power_picker");
            ...
            PrepareStatement(HotfixStatements.SEL_ARTIFACT_POWER_RANK_MAX_ID, "SELECT MAX(ID) + 1 FROM artifact_power_rank");
            ...
            PrepareStatement(HotfixStatements.SEL_ARTIFACT_QUEST_XP_MAX_ID, "SELECT MAX(ID) + 1 FROM artifact_quest_xp");
            ...
            PrepareStatement(HotfixStatements.SEL_ARTIFACT_TIER_MAX_ID, "SELECT MAX(ID) + 1 FROM artifact_tier");
            ...
            PrepareStatement(HotfixStatements.SEL_ARTIFACT_UNLOCK, "SELECT ID, PowerID, PowerRank, ItemBonusListID, PlayerConditionID, ArtifactID FROM artifact_unlock" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_ARTIFACT_UNLOCK_MAX_ID, "SELECT MAX(ID) + 1 FROM artifact_unlock");
            ...
            PrepareStatement(HotfixStatements.SEL_AUCTION_HOUSE, "SELECT ID, Name, FactionID, DepositRate, ConsignmentRate FROM auction_house" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_AUCTION_HOUSE_MAX_ID, "SELECT MAX(ID) + 1 FROM auction_house");
            ...
            PrepareStatement(HotfixStatements.SEL_AZERITE_EMPOWERED_ITEM, "SELECT ID, ItemID, AzeriteTierUnlockSetID, AzeritePowerSetID FROM azerite_empowered_item" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_AZERITE_EMPOWERED_ITEM_MAX_ID, "SELECT MAX(ID) + 1 FROM azerite_empowered_item");
            ...
            PrepareStatement(HotfixStatements.SEL_AZERITE_ESSENCE_MAX_ID, "SELECT MAX(ID) + 1 FROM azerite_essence");
            ...
            PrepareStatement(HotfixStatements.SEL_AZERITE_ESSENCE_POWER_MAX_ID, "SELECT MAX(ID) + 1 FROM azerite_essence_power");
            ...
            PrepareStatement(HotfixStatements.SEL_AZERITE_ITEM_MAX_ID, "SELECT MAX(ID) + 1 FROM azerite_item");
            ...
            PrepareStatement(HotfixStatements.SEL_AZERITE_ITEM_MILESTONE_POWER_MAX_ID, "SELECT MAX(ID) + 1 FROM azerite_item_milestone_power");
            ...
            PrepareStatement(HotfixStatements.SEL_AZERITE_KNOWLEDGE_MULTIPLIER_MAX_ID, "SELECT MAX(ID) + 1 FROM azerite_knowledge_multiplier");
            ...
            PrepareStatement(HotfixStatements.SEL_AZERITE_LEVEL_INFO_MAX_ID, "SELECT MAX(ID) + 1 FROM azerite_level_info");

            // AzeritePower.db2
            PrepareStatement(HotfixStatements.SEL_AZERITE_POWER, "SELECT ID, SpellID, ItemBonusListID, SpecSetID, Flags FROM azerite_power" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_AZERITE_POWER_MAX_ID, "SELECT MAX(ID) + 1 FROM azerite_power");
            ...
            PrepareStatement(HotfixStatements.SEL_AZERITE_POWER_SET_MEMBER_MAX_ID, "SELECT MAX(ID) + 1 FROM azerite_power_set_member");
            ...
            PrepareStatement(HotfixStatements.SEL_AZERITE_TIER_UNLOCK_MAX_ID, "SELECT MAX(ID) + 1 FROM azerite_tier_unlock");
            ...
            PrepareStatement(HotfixStatements.SEL_AZERITE_TIER_UNLOCK_SET_MAX_ID, "SELECT MAX(ID) + 1 FROM azerite_tier_unlock_set");
            ...
            PrepareStatement(HotfixStatements.SEL_AZERITE_UNLOCK_MAPPING_MAX_ID, "SELECT MAX(ID) + 1 FROM azerite_unlock_mapping");
            ...
            PrepareStatement(HotfixStatements.SEL_BANK_BAG_SLOT_PRICES_MAX_ID, "SELECT MAX(ID) + 1 FROM bank_bag_slot_prices");
            ...
            PrepareStatement(HotfixStatements.SEL_BANNED_ADDONS_MAX_ID, "SELECT MAX(ID) + 1 FROM banned_addons");
            ...
            PrepareStatement(HotfixStatements.SEL_BARBER_SHOP_STYLE, "SELECT ID, DisplayName, Description, Type, CostModifier, Race, Sex, Data FROM barber_shop_style" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_BARBER_SHOP_STYLE_MAX_ID, "SELECT MAX(ID) + 1 FROM barber_shop_style");
            ...
            PrepareStatement(HotfixStatements.SEL_BATTLE_PET_ABILITY_MAX_ID, "SELECT MAX(ID) + 1 FROM battle_pet_ability");
            ...
            PrepareStatement(HotfixStatements.SEL_BATTLE_PET_BREED_QUALITY, "SELECT ID, MaxQualityRoll, StateMultiplier, QualityEnum FROM battle_pet_breed_quality" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_BATTLE_PET_BREED_QUALITY_MAX_ID, "SELECT MAX(ID) + 1 FROM battle_pet_breed_quality");
            ...
            PrepareStatement(HotfixStatements.SEL_BATTLE_PET_BREED_STATE, "SELECT ID, BattlePetStateID, Value, BattlePetBreedID FROM battle_pet_breed_state" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_BATTLE_PET_BREED_STATE_MAX_ID, "SELECT MAX(ID) + 1 FROM battle_pet_breed_state");
            ...
            PrepareStatement(HotfixStatements.SEL_BATTLE_PET_SPECIES_MAX_ID, "SELECT MAX(ID) + 1 FROM battle_pet_species");
            ...
            PrepareStatement(HotfixStatements.SEL_BATTLE_PET_SPECIES_STATE, "SELECT ID, BattlePetStateID, Value, BattlePetSpeciesID FROM battle_pet_species_state" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_BATTLE_PET_SPECIES_STATE_MAX_ID, "SELECT MAX(ID) + 1 FROM battle_pet_species_state");
            ...
            PrepareStatement(HotfixStatements.SEL_BATTLEMASTER_LIST_MAX_ID, "SELECT MAX(ID) + 1 FROM battlemaster_list");
            ...
            PrepareStatement(HotfixStatements.SEL_BROADCAST_TEXT, "SELECT `Text`, Text1, ID, LanguageID, ConditionID, EmotesID, Flags, ChatBubbleDurationMs, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_BROADCAST_TEXT_MAX_ID, "SELECT MAX(ID) + 1 FROM broadcast_text");
            ...
            PrepareStatement(HotfixStatements.SEL_BROADCAST_TEXT_DURATION, "SELECT ID, BroadcastTextID, Locale, Duration FROM broadcast_text_duration" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_BROADCAST_TEXT_DURATION_MAX_ID, "SELECT MAX(ID) + 1 FROM broadcast_text_duration");
            ...
            PrepareStatement(HotfixStatements.SEL_CFG_CATEGORIES_MAX_ID, "SELECT MAX(ID) + 1 FROM cfg_categories");
            ...
            PrepareStatement(HotfixStatements.SEL_CFG_REGIONS, "SELECT ID, Tag, RegionID, Raidorigin, RegionGroupMask, ChallengeOrigin FROM cfg_regions" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_CFG_REGIONS_MAX_ID, "SELECT MAX(ID) + 1 FROM cfg_regions");
            ...
            PrepareStatement(HotfixStatements.SEL_CHALLENGE_MODE_ITEM_BONUS_OVERRIDE_MAX_ID, "SELECT MAX(ID) + 1 FROM challenge_mode_item_bonus_override");
            ...
            PrepareStatement(HotfixStatements.SEL_CHAR_TITLES_MAX_ID, "SELECT MAX(ID) + 1 FROM char_titles");
            ...
            PrepareStatement(HotfixStatements.SEL_CHARACTER_LOADOUT, "SELECT ID, RaceMask, ChrClassID, Purpose, ItemContext FROM character_loadout" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_CHARACTER_LOADOUT_MAX_ID, "SELECT MAX(ID) + 1 FROM character_loadout");
            ...
            PrepareStatement(HotfixStatements.SEL_CHARACTER_LOADOUT_ITEM, "SELECT ID, CharacterLoadoutID, ItemID FROM character_loadout_item" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_CHARACTER_LOADOUT_ITEM_MAX_ID, "SELECT MAX(ID) + 1 FROM character_loadout_item");
            ...
            PrepareStatement(HotfixStatements.SEL_CHAT_CHANNELS, "SELECT ID, Name, Shortcut, Flags, FactionGroup, Ruleset FROM chat_channels" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_CHAT_CHANNELS_MAX_ID, "SELECT MAX(ID) + 1 FROM chat_channels");
            ...
            PrepareStatement(HotfixStatements.SEL_CHR_CLASS_UI_DISPLAY_MAX_ID, "SELECT MAX(ID) + 1 FROM chr_class_ui_display");
            ...
            PrepareStatement(HotfixStatements.SEL_CHR_CLASSES_MAX_ID, "SELECT MAX(ID) + 1 FROM chr_classes");
            ...
            PrepareStatement(HotfixStatements.SEL_CHR_CLASSES_X_POWER_TYPES, "SELECT ID, PowerType, ClassID FROM chr_classes_x_power_types" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_CHR_CLASSES_X_POWER_TYPES_MAX_ID, "SELECT MAX(ID) + 1 FROM chr_classes_x_power_types");
            ...
            PrepareStatement(HotfixStatements.SEL_CHR_CUSTOMIZATION_CHOICE, "SELECT Name, ID, ChrCustomizationOptionID, ChrCustomizationReqID, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_CHR_CUSTOMIZATION_CHOICE_MAX_ID, "SELECT MAX(ID) + 1 FROM chr_customization_choice");
            ...
            PrepareStatement(HotfixStatements.SEL_CHR_CUSTOMIZATION_DISPLAY_INFO_MAX_ID, "SELECT MAX(ID) + 1 FROM chr_customization_display_info");
            ...
            PrepareStatement(HotfixStatements.SEL_CHR_CUSTOMIZATION_ELEMENT_MAX_ID, "SELECT MAX(ID) + 1 FROM chr_customization_element");
            ...
            PrepareStatement(HotfixStatements.SEL_CHR_CUSTOMIZATION_OPTION, "SELECT Name, ID, SecondaryID, Flags, ChrModelID, SortIndex, ChrCustomizationCategoryID, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_CHR_CUSTOMIZATION_OPTION_MAX_ID, "SELECT MAX(ID) + 1 FROM chr_customization_option");
            ...
            PrepareStatement(HotfixStatements.SEL_CHR_CUSTOMIZATION_REQ_MAX_ID, "SELECT MAX(ID) + 1 FROM chr_customization_req");
            ...
            PrepareStatement(HotfixStatements.SEL_CHR_CUSTOMIZATION_REQ_CHOICE_MAX_ID, "SELECT MAX(ID) + 1 FROM chr_customization_req_choice");
            ...
            PrepareStatement(HotfixStatements.SEL_CHR_MODEL_MAX_ID, "SELECT MAX(ID) + 1 FROM chr_model");
            ...
            PrepareStatement(HotfixStatements.SEL_CHR_RACE_X_CHR_MODEL, "SELECT ID, ChrRacesID, ChrModelID, Sex, AllowedTransmogSlots FROM chr_race_x_chr_model" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_CHR_RACE_X_CHR_MODEL_MAX_ID, "SELECT MAX(ID) + 1 FROM chr_race_x_chr_model");
            ...
            PrepareStatement(HotfixStatements.SEL_CHR_RACES_MAX_ID, "SELECT MAX(ID) + 1 FROM chr_races");
            ...
            PrepareStatement(HotfixStatements.SEL_CHR_SPECIALIZATION, "SELECT Name, FemaleName, Description, ID, ClassID, OrderIndex, PetTalentType, Role, Flags, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_CHR_SPECIALIZATION_MAX_ID, "SELECT MAX(ID) + 1 FROM chr_specialization");
            ...
            PrepareStatement(HotfixStatements.SEL_CINEMATIC_CAMERA_MAX_ID, "SELECT MAX(ID) + 1 FROM cinematic_camera");
            ...
            PrepareStatement(HotfixStatements.SEL_CINEMATIC_SEQUENCES_MAX_ID, "SELECT MAX(ID) + 1 FROM cinematic_sequences");
            ...
            PrepareStatement(HotfixStatements.SEL_CONDITIONAL_CONTENT_TUNING_MAX_ID, "SELECT MAX(ID) + 1 FROM conditional_content_tuning");
            ...
            PrepareStatement(HotfixStatements.SEL_CONTENT_TUNING_MAX_ID, "SELECT MAX(ID) + 1 FROM content_tuning");
            ...
            PrepareStatement(HotfixStatements.SEL_CONTENT_TUNING_X_EXPECTED_MAX_ID, "SELECT MAX(ID) + 1 FROM content_tuning_x_expected");
            ...
            PrepareStatement(HotfixStatements.SEL_CONTENT_TUNING_X_LABEL, "SELECT ID, LabelID, ContentTuningID FROM content_tuning_x_label" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_CONTENT_TUNING_X_LABEL_MAX_ID, "SELECT MAX(ID) + 1 FROM content_tuning_x_label");
            ...
            PrepareStatement(HotfixStatements.SEL_CONVERSATION_LINE_MAX_ID, "SELECT MAX(ID) + 1 FROM conversation_line");
            ...
            PrepareStatement(HotfixStatements.SEL_CORRUPTION_EFFECTS, "SELECT ID, MinCorruption, Aura, PlayerConditionID, Flags FROM corruption_effects" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_CORRUPTION_EFFECTS_MAX_ID, "SELECT MAX(ID) + 1 FROM corruption_effects");
            ...
            PrepareStatement(HotfixStatements.SEL_CREATURE_DISPLAY_INFO_MAX_ID, "SELECT MAX(ID) + 1 FROM creature_display_info");
            ...
            PrepareStatement(HotfixStatements.SEL_CREATURE_DISPLAY_INFO_EXTRA_MAX_ID, "SELECT MAX(ID) + 1 FROM creature_display_info_extra");
            ...
            PrepareStatement(HotfixStatements.SEL_CREATURE_FAMILY_MAX_ID, "SELECT MAX(ID) + 1 FROM creature_family");
            ...
            PrepareStatement(HotfixStatements.SEL_CREATURE_MODEL_DATA_MAX_ID, "SELECT MAX(ID) + 1 FROM creature_model_data");

            // CreatureType.db2
            PrepareStatement(HotfixStatements.SEL_CREATURE_TYPE, "SELECT ID, Name, Flags FROM creature_type WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_CREATURE_TYPE_MAX_ID, "SELECT MAX(ID) + 1 FROM creature_type");
            ...
            PrepareStatement(HotfixStatements.SEL_CRITERIA_MAX_ID, "SELECT MAX(ID) + 1 FROM criteria");
            ...
            PrepareStatement(HotfixStatements.SEL_CRITERIA_TREE, "SELECT ID, Description, Parent, Amount, Operator, CriteriaID, OrderIndex, Flags FROM criteria_tree" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_CRITERIA_TREE_MAX_ID, "SELECT MAX(ID) + 1 FROM criteria_tree");
            ...
            PrepareStatement(HotfixStatements.SEL_CURRENCY_CONTAINER_MAX_ID, "SELECT MAX(ID) + 1 FROM currency_container");
            ...
            PrepareStatement(HotfixStatements.SEL_CURRENCY_TYPES_MAX_ID, "SELECT MAX(ID) + 1 FROM currency_types");
            ...
            PrepareStatement(HotfixStatements.SEL_CURVE_MAX_ID, "SELECT MAX(ID) + 1 FROM curve");
            ...
            PrepareStatement(HotfixStatements.SEL_CURVE_POINT, "SELECT PosX, PosY, PreSLSquishPosX, PreSLSquishPosY, ID, CurveID, OrderIndex FROM curve_point" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_CURVE_POINT_MAX_ID, "SELECT MAX(ID) + 1 FROM curve_point");
            ...
            PrepareStatement(HotfixStatements.SEL_DESTRUCTIBLE_MODEL_DATA, "SELECT ID, State0ImpactEffectDoodadSet, State0AmbientDoodadSet, State1Wmo, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_DESTRUCTIBLE_MODEL_DATA_MAX_ID, "SELECT MAX(ID) + 1 FROM destructible_model_data");
            ...
            PrepareStatement(HotfixStatements.SEL_DIFFICULTY, "SELECT ID, Name, InstanceType, OrderIndex, OldEnumValue, FallbackDifficultyID, MinPlayers, MaxPlayers, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_DIFFICULTY_MAX_ID, "SELECT MAX(ID) + 1 FROM difficulty");
            ...
            PrepareStatement(HotfixStatements.SEL_DUNGEON_ENCOUNTER_MAX_ID, "SELECT MAX(ID) + 1 FROM dungeon_encounter");
            ...
            PrepareStatement(HotfixStatements.SEL_DURABILITY_COSTS_MAX_ID, "SELECT MAX(ID) + 1 FROM durability_costs");
            ...
            PrepareStatement(HotfixStatements.SEL_DURABILITY_QUALITY_MAX_ID, "SELECT MAX(ID) + 1 FROM durability_quality");
            ...
            PrepareStatement(HotfixStatements.SEL_EMOTES_MAX_ID, "SELECT MAX(ID) + 1 FROM emotes");

            // EmotesText.db2
            PrepareStatement(HotfixStatements.SEL_EMOTES_TEXT, "SELECT ID, Name, EmoteID FROM emotes_text WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_EMOTES_TEXT_MAX_ID, "SELECT MAX(ID) + 1 FROM emotes_text");
            ...
            PrepareStatement(HotfixStatements.SEL_EMOTES_TEXT_SOUND, "SELECT ID, RaceID, ClassID, SexID, SoundID, EmotesTextID FROM emotes_text_sound" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_EMOTES_TEXT_SOUND_MAX_ID, "SELECT MAX(ID) + 1 FROM emotes_text_sound");
            ...
            PrepareStatement(HotfixStatements.SEL_EXPECTED_STAT, "SELECT ID, ExpansionID, CreatureHealth, PlayerHealth, CreatureAutoAttackDps, CreatureArmor, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_EXPECTED_STAT_MAX_ID, "SELECT MAX(ID) + 1 FROM expected_stat");
            ...
            PrepareStatement(HotfixStatements.SEL_EXPECTED_STAT_MOD, "SELECT ID, CreatureHealthMod, PlayerHealthMod, CreatureAutoAttackDPSMod, CreatureArmorMod, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_EXPECTED_STAT_MOD_MAX_ID, "SELECT MAX(ID) + 1 FROM expected_stat_mod");
            ...
            PrepareStatement(HotfixStatements.SEL_FACTION, "SELECT ID, ReputationRaceMask1, ReputationRaceMask2, ReputationRaceMask3, ReputationRaceMask4, Name, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_FACTION_MAX_ID, "SELECT MAX(ID) + 1 FROM faction");
            ...
            PrepareStatement(HotfixStatements.SEL_FACTION_TEMPLATE_MAX_ID, "SELECT MAX(ID) + 1 FROM faction_template");
            ...
            PrepareStatement(HotfixStatements.SEL_FRIENDSHIP_REP_REACTION_MAX_ID, "SELECT MAX(ID) + 1 FROM friendship_rep_reaction");
            ...
            PrepareStatement(HotfixStatements.SEL_FRIENDSHIP_REPUTATION_MAX_ID, "SELECT MAX(ID) + 1 FROM friendship_reputation");
            ...
            PrepareStatement(HotfixStatements.SEL_GAMEOBJECT_ART_KIT_MAX_ID, "SELECT MAX(ID) + 1 FROM gameobject_art_kit");
            ...
            PrepareStatement(HotfixStatements.SEL_GAMEOBJECT_DISPLAY_INFO_MAX_ID, "SELECT MAX(ID) + 1 FROM gameobject_display_info");
            ...
            PrepareStatement(HotfixStatements.SEL_GAMEOBJECTS_MAX_ID, "SELECT MAX(ID) + 1 FROM gameobjects");
            ...
            PrepareStatement(HotfixStatements.SEL_GARR_ABILITY_MAX_ID, "SELECT MAX(ID) + 1 FROM garr_ability");
            ...
            PrepareStatement(HotfixStatements.SEL_GARR_BUILDING_MAX_ID, "SELECT MAX(ID) + 1 FROM garr_building");
            ...
            PrepareStatement(HotfixStatements.SEL_GARR_BUILDING_PLOT_INST_MAX_ID, "SELECT MAX(ID) + 1 FROM garr_building_plot_inst");
            ...
            PrepareStatement(HotfixStatements.SEL_GARR_CLASS_SPEC_MAX_ID, "SELECT MAX(ID) + 1 FROM garr_class_spec");
            ...
            PrepareStatement(HotfixStatements.SEL_GARR_FOLLOWER_MAX_ID, "SELECT MAX(ID) + 1 FROM garr_follower");
            ...
            PrepareStatement(HotfixStatements.SEL_GARR_FOLLOWER_X_ABILITY_MAX_ID, "SELECT MAX(ID) + 1 FROM garr_follower_x_ability");
            ...
            PrepareStatement(HotfixStatements.SEL_GARR_MISSION_MAX_ID, "SELECT MAX(ID) + 1 FROM garr_mission");
            ...
            PrepareStatement(HotfixStatements.SEL_GARR_PLOT_MAX_ID, "SELECT MAX(ID) + 1 FROM garr_plot");
            ...
            PrepareStatement(HotfixStatements.SEL_GARR_PLOT_BUILDING_MAX_ID, "SELECT MAX(ID) + 1 FROM garr_plot_building");
            ...
            PrepareStatement(HotfixStatements.SEL_GARR_PLOT_INSTANCE_MAX_ID, "SELECT MAX(ID) + 1 FROM garr_plot_instance");
            ...
            PrepareStatement(HotfixStatements.SEL_GARR_SITE_LEVEL_MAX_ID, "SELECT MAX(ID) + 1 FROM garr_site_level");
            ...
            PrepareStatement(HotfixStatements.SEL_GARR_SITE_LEVEL_PLOT_INST_MAX_ID, "SELECT MAX(ID) + 1 FROM garr_site_level_plot_inst");
            ...
            PrepareStatement(HotfixStatements.SEL_GARR_TALENT_TREE, "SELECT ID, Name, GarrTypeID, ClassID, MaxTiers, UiOrder, Flags, UiTextureKitID, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_GARR_TALENT_TREE_MAX_ID, "SELECT MAX(ID) + 1 FROM garr_talent_tree");
            ...
            PrepareStatement(HotfixStatements.SEL_GEM_PROPERTIES_MAX_ID, "SELECT MAX(ID) + 1 FROM gem_properties");

            // GlobalCurve.db2
            PrepareStatement(HotfixStatements.SEL_GLOBAL_CURVE, "SELECT ID, CurveID, Type FROM global_curve WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_GLOBAL_CURVE_MAX_ID, "SELECT MAX(ID) + 1 FROM global_curve");
            ...
            PrepareStatement(HotfixStatements.SEL_GLYPH_BINDABLE_SPELL_MAX_ID, "SELECT MAX(ID) + 1 FROM glyph_bindable_spell");
            ...
            PrepareStatement(HotfixStatements.SEL_GLYPH_PROPERTIES, "SELECT ID, SpellID, GlyphType, GlyphExclusiveCategoryID, SpellIconFileDataID FROM glyph_properties" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_GLYPH_PROPERTIES_MAX_ID, "SELECT MAX(ID) + 1 FROM glyph_properties");
            ...
            PrepareStatement(HotfixStatements.SEL_GLYPH_REQUIRED_SPEC, "SELECT ID, ChrSpecializationID, GlyphPropertiesID FROM glyph_required_spec" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_GLYPH_REQUIRED_SPEC_MAX_ID, "SELECT MAX(ID) + 1 FROM glyph_required_spec");
            ...
            PrepareStatement(HotfixStatements.SEL_GOSSIP_NPC_OPTION_MAX_ID, "SELECT MAX(ID) + 1 FROM gossip_npc_option");
            ...
            PrepareStatement(HotfixStatements.SEL_GUILD_COLOR_BACKGROUND_MAX_ID, "SELECT MAX(ID) + 1 FROM guild_color_background");
            ...
            PrepareStatement(HotfixStatements.SEL_GUILD_COLOR_BORDER_MAX_ID, "SELECT MAX(ID) + 1 FROM guild_color_border");
            ...
            PrepareStatement(HotfixStatements.SEL_GUILD_COLOR_EMBLEM_MAX_ID, "SELECT MAX(ID) + 1 FROM guild_color_emblem");

            // GuildPerkSpells.db2
            PrepareStatement(HotfixStatements.SEL_GUILD_PERK_SPELLS, "SELECT ID, SpellID FROM guild_perk_spells WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_GUILD_PERK_SPELLS_MAX_ID, "SELECT MAX(ID) + 1 FROM guild_perk_spells");
            ...
            PrepareStatement(HotfixStatements.SEL_HEIRLOOM, "SELECT SourceText, ID, ItemID, LegacyUpgradedItemID, StaticUpgradedItemID, SourceTypeEnum, Flags, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_HEIRLOOM_MAX_ID, "SELECT MAX(ID) + 1 FROM heirloom");
            ...
            PrepareStatement(HotfixStatements.SEL_HOLIDAYS, "SELECT ID, Region, Looping, HolidayNameID, HolidayDescriptionID, Priority, CalendarFilterType, Flags, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_HOLIDAYS_MAX_ID, "SELECT MAX(ID) + 1 FROM holidays");
            ...
            PrepareStatement(HotfixStatements.SEL_IMPORT_PRICE_ARMOR, "SELECT ID, ClothModifier, LeatherModifier, ChainModifier, PlateModifier FROM import_price_armor" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_IMPORT_PRICE_ARMOR_MAX_ID, "SELECT MAX(ID) + 1 FROM import_price_armor");
            ...
            PrepareStatement(HotfixStatements.SEL_IMPORT_PRICE_QUALITY_MAX_ID, "SELECT MAX(ID) + 1 FROM import_price_quality");
            ...
            PrepareStatement(HotfixStatements.SEL_IMPORT_PRICE_SHIELD_MAX_ID, "SELECT MAX(ID) + 1 FROM import_price_shield");
            ...
            PrepareStatement(HotfixStatements.SEL_IMPORT_PRICE_WEAPON_MAX_ID, "SELECT MAX(ID) + 1 FROM import_price_weapon");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_MAX_ID, "SELECT MAX(ID) + 1 FROM item");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_APPEARANCE_MAX_ID, "SELECT MAX(ID) + 1 FROM item_appearance");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_ARMOR_QUALITY_MAX_ID, "SELECT MAX(ID) + 1 FROM item_armor_quality");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_ARMOR_SHIELD_MAX_ID, "SELECT MAX(ID) + 1 FROM item_armor_shield");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_ARMOR_TOTAL, "SELECT ID, ItemLevel, Cloth, Leather, Mail, Plate FROM item_armor_total" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_ITEM_ARMOR_TOTAL_MAX_ID, "SELECT MAX(ID) + 1 FROM item_armor_total");

            // ItemBagFamily.db2
            PrepareStatement(HotfixStatements.SEL_ITEM_BAG_FAMILY, "SELECT ID, Name FROM item_bag_family WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_ITEM_BAG_FAMILY_MAX_ID, "SELECT MAX(ID) + 1 FROM item_bag_family");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_BONUS, "SELECT ID, Value1, Value2, Value3, Value4, ParentItemBonusListID, Type, OrderIndex FROM item_bonus" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_ITEM_BONUS_MAX_ID, "SELECT MAX(ID) + 1 FROM item_bonus");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_BONUS_LIST_GROUP_ENTRY_MAX_ID, "SELECT MAX(ID) + 1 FROM item_bonus_list_group_entry");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_BONUS_LIST_LEVEL_DELTA, "SELECT ItemLevelDelta, ID FROM item_bonus_list_level_delta" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_ITEM_BONUS_LIST_LEVEL_DELTA_MAX_ID, "SELECT MAX(ID) + 1 FROM item_bonus_list_level_delta");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_BONUS_TREE_MAX_ID, "SELECT MAX(ID) + 1 FROM item_bonus_tree");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_BONUS_TREE_NODE, "SELECT ID, ItemContext, ChildItemBonusTreeID, ChildItemBonusListID, ChildItemLevelSelectorID, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_ITEM_BONUS_TREE_NODE_MAX_ID, "SELECT MAX(ID) + 1 FROM item_bonus_tree_node");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_CHILD_EQUIPMENT, "SELECT ID, ParentItemID, ChildItemID, ChildItemEquipSlot FROM item_child_equipment" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_ITEM_CHILD_EQUIPMENT_MAX_ID, "SELECT MAX(ID) + 1 FROM item_child_equipment");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_CLASS_MAX_ID, "SELECT MAX(ID) + 1 FROM item_class");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_CONTEXT_PICKER_ENTRY_MAX_ID, "SELECT MAX(ID) + 1 FROM item_context_picker_entry");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_CURRENCY_COST_MAX_ID, "SELECT MAX(ID) + 1 FROM item_currency_cost");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_DAMAGE_AMMO_MAX_ID, "SELECT MAX(ID) + 1 FROM item_damage_ammo");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_DAMAGE_ONE_HAND_MAX_ID, "SELECT MAX(ID) + 1 FROM item_damage_one_hand");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_DAMAGE_ONE_HAND_CASTER_MAX_ID, "SELECT MAX(ID) + 1 FROM item_damage_one_hand_caster");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_DAMAGE_TWO_HAND_MAX_ID, "SELECT MAX(ID) + 1 FROM item_damage_two_hand");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_DAMAGE_TWO_HAND_CASTER_MAX_ID, "SELECT MAX(ID) + 1 FROM item_damage_two_hand_caster");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_DISENCHANT_LOOT_MAX_ID, "SELECT MAX(ID) + 1 FROM item_disenchant_loot");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_EFFECT_MAX_ID, "SELECT MAX(ID) + 1 FROM item_effect");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_EXTENDED_COST_MAX_ID, "SELECT MAX(ID) + 1 FROM item_extended_cost");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_LEVEL_SELECTOR_MAX_ID, "SELECT MAX(ID) + 1 FROM item_level_selector");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_LEVEL_SELECTOR_QUALITY_MAX_ID, "SELECT MAX(ID) + 1 FROM item_level_selector_quality");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_LEVEL_SELECTOR_QUALITY_SET, "SELECT ID, IlvlRare, IlvlEpic FROM item_level_selector_quality_set" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_ITEM_LEVEL_SELECTOR_QUALITY_SET_MAX_ID, "SELECT MAX(ID) + 1 FROM item_level_selector_quality_set");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_LIMIT_CATEGORY_MAX_ID, "SELECT MAX(ID) + 1 FROM item_limit_category");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_LIMIT_CATEGORY_CONDITION_MAX_ID, "SELECT MAX(ID) + 1 FROM item_limit_category_condition");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_MODIFIED_APPEARANCE_MAX_ID, "SELECT MAX(ID) + 1 FROM item_modified_appearance");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_MODIFIED_APPEARANCE_EXTRA_MAX_ID, "SELECT MAX(ID) + 1 FROM item_modified_appearance_extra");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_NAME_DESCRIPTION_MAX_ID, "SELECT MAX(ID) + 1 FROM item_name_description");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_PRICE_BASE_MAX_ID, "SELECT MAX(ID) + 1 FROM item_price_base");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_SEARCH_NAME_MAX_ID, "SELECT MAX(ID) + 1 FROM item_search_name");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_SET, "SELECT ID, Name, SetFlags, RequiredSkill, RequiredSkillRank, ItemID1, ItemID2, ItemID3, ItemID4, ItemID5, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_ITEM_SET_MAX_ID, "SELECT MAX(ID) + 1 FROM item_set");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_SET_SPELL, "SELECT ID, ChrSpecID, SpellID, Threshold, ItemSetID FROM item_set_spell" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_ITEM_SET_SPELL_MAX_ID, "SELECT MAX(ID) + 1 FROM item_set_spell");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_SPARSE, "SELECT ID, AllowableRace, Description, Display3, Display2, Display1, Display, ExpansionID, DmgVariance, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_ITEM_SPARSE_MAX_ID, "SELECT MAX(ID) + 1 FROM item_sparse");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_SPEC, "SELECT ID, MinLevel, MaxLevel, ItemType, PrimaryStat, SecondaryStat, SpecializationID FROM item_spec" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_ITEM_SPEC_MAX_ID, "SELECT MAX(ID) + 1 FROM item_spec");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_SPEC_OVERRIDE_MAX_ID, "SELECT MAX(ID) + 1 FROM item_spec_override");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_X_BONUS_TREE_MAX_ID, "SELECT MAX(ID) + 1 FROM item_x_bonus_tree");
            ...
            PrepareStatement(HotfixStatements.SEL_ITEM_X_ITEM_EFFECT_MAX_ID, "SELECT MAX(ID) + 1 FROM item_x_item_effect");
            ...
            PrepareStatement(HotfixStatements.SEL_JOURNAL_ENCOUNTER_MAX_ID, "SELECT MAX(ID) + 1 FROM journal_encounter");
            ...
            PrepareStatement(HotfixStatements.SEL_JOURNAL_ENCOUNTER_SECTION_MAX_ID, "SELECT MAX(ID) + 1 FROM journal_encounter_section");
            ...
            PrepareStatement(HotfixStatements.SEL_JOURNAL_INSTANCE_MAX_ID, "SELECT MAX(ID) + 1 FROM journal_instance");
            ...
            PrepareStatement(HotfixStatements.SEL_JOURNAL_TIER_MAX_ID, "SELECT MAX(ID) + 1 FROM journal_tier");
            ...
            PrepareStatement(HotfixStatements.SEL_KEYCHAIN, "SELECT ID, Key1, Key2, Key3, Key4, Key5, Key6, Key7, Key8, Key9, Key10, Key11, Key12, Key13, Key14, Key15, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_KEYCHAIN_MAX_ID, "SELECT MAX(ID) + 1 FROM keychain");
            ...
            PrepareStatement(HotfixStatements.SEL_KEYSTONE_AFFIX_MAX_ID, "SELECT MAX(ID) + 1 FROM keystone_affix");
            ...
            PrepareStatement(HotfixStatements.SEL_LANGUAGE_WORDS_MAX_ID, "SELECT MAX(ID) + 1 FROM language_words");
            ...
            PrepareStatement(HotfixStatements.SEL_LANGUAGES, "SELECT Name, ID, Flags, UiTextureKitID, UiTextureKitElementCount, LearningCurveID FROM languages" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_LANGUAGES_MAX_ID, "SELECT MAX(ID) + 1 FROM languages");
            ...
            PrepareStatement(HotfixStatements.SEL_LFG_DUNGEONS_MAX_ID, "SELECT MAX(ID) + 1 FROM lfg_dungeons");
            ...
            PrepareStatement(HotfixStatements.SEL_LIGHT, "SELECT ID, GameCoordsX, GameCoordsY, GameCoordsZ, GameFalloffStart, GameFalloffEnd, ContinentID, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_LIGHT_MAX_ID, "SELECT MAX(ID) + 1 FROM light");
            ...
            PrepareStatement(HotfixStatements.SEL_LIQUID_TYPE_MAX_ID, "SELECT MAX(ID) + 1 FROM liquid_type");
            ...
            PrepareStatement(HotfixStatements.SEL_LOCK_MAX_ID, "SELECT MAX(ID) + 1 FROM `lock`");

            // MailTemplate.db2
            PrepareStatement(HotfixStatements.SEL_MAIL_TEMPLATE, "SELECT ID, Body FROM mail_template WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_MAIL_TEMPLATE_MAX_ID, "SELECT MAX(ID) + 1 FROM mail_template");
            ...
            PrepareStatement(HotfixStatements.SEL_MAP_MAX_ID, "SELECT MAX(ID) + 1 FROM map");
            ...
            PrepareStatement(HotfixStatements.SEL_MAP_CHALLENGE_MODE_MAX_ID, "SELECT MAX(ID) + 1 FROM map_challenge_mode");
            ...
            PrepareStatement(HotfixStatements.SEL_MAP_DIFFICULTY_MAX_ID, "SELECT MAX(ID) + 1 FROM map_difficulty");
            ...
            PrepareStatement(HotfixStatements.SEL_MAP_DIFFICULTY_X_CONDITION_MAX_ID, "SELECT MAX(ID) + 1 FROM map_difficulty_x_condition");
            ...
            PrepareStatement(HotfixStatements.SEL_MAW_POWER_MAX_ID, "SELECT MAX(ID) + 1 FROM maw_power");
            ...
            PrepareStatement(HotfixStatements.SEL_MODIFIER_TREE, "SELECT ID, Parent, Operator, Amount, Type, Asset, SecondaryAsset, TertiaryAsset FROM modifier_tree" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_MODIFIER_TREE_MAX_ID, "SELECT MAX(ID) + 1 FROM modifier_tree");
            ...
            PrepareStatement(HotfixStatements.SEL_MOUNT, "SELECT Name, SourceText, Description, ID, MountTypeID, Flags, SourceTypeEnum, SourceSpellID, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_MOUNT_MAX_ID, "SELECT MAX(ID) + 1 FROM mount");
            ...
            PrepareStatement(HotfixStatements.SEL_MOUNT_CAPABILITY_MAX_ID, "SELECT MAX(ID) + 1 FROM mount_capability");
            ...
            PrepareStatement(HotfixStatements.SEL_MOUNT_TYPE_X_CAPABILITY, "SELECT ID, MountTypeID, MountCapabilityID, OrderIndex FROM mount_type_x_capability" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_MOUNT_TYPE_X_CAPABILITY_MAX_ID, "SELECT MAX(ID) + 1 FROM mount_type_x_capability");
            ...
            PrepareStatement(HotfixStatements.SEL_MOUNT_X_DISPLAY, "SELECT ID, CreatureDisplayInfoID, PlayerConditionID, MountID FROM mount_x_display" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_MOUNT_X_DISPLAY_MAX_ID, "SELECT MAX(ID) + 1 FROM mount_x_display");
            ...
            PrepareStatement(HotfixStatements.SEL_MOVIE, "SELECT ID, Volume, KeyID, AudioFileDataID, SubtitleFileDataID, SubtitleFileFormat FROM movie" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_MOVIE_MAX_ID, "SELECT MAX(ID) + 1 FROM movie");
            ...
            PrepareStatement(HotfixStatements.SEL_MYTHIC_PLUS_SEASON, "SELECT ID, MilestoneSeason, ExpansionLevel, HeroicLFGDungeonMinGear FROM mythic_plus_season" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_MYTHIC_PLUS_SEASON_MAX_ID, "SELECT MAX(ID) + 1 FROM mythic_plus_season");

            // NameGen.db2
            PrepareStatement(HotfixStatements.SEL_NAME_GEN, "SELECT ID, Name, RaceID, Sex FROM name_gen WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_NAME_GEN_MAX_ID, "SELECT MAX(ID) + 1 FROM name_gen");

            // NamesProfanity.db2
            PrepareStatement(HotfixStatements.SEL_NAMES_PROFANITY, "SELECT ID, Name, Language FROM names_profanity WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_NAMES_PROFANITY_MAX_ID, "SELECT MAX(ID) + 1 FROM names_profanity");

            // NamesReserved.db2
            PrepareStatement(HotfixStatements.SEL_NAMES_RESERVED, "SELECT ID, Name FROM names_reserved WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_NAMES_RESERVED_MAX_ID, "SELECT MAX(ID) + 1 FROM names_reserved");
            ...
            PrepareStatement(HotfixStatements.SEL_NAMES_RESERVED_LOCALE_MAX_ID, "SELECT MAX(ID) + 1 FROM names_reserved_locale");
            ...
            PrepareStatement(HotfixStatements.SEL_NUM_TALENTS_AT_LEVEL, "SELECT ID, NumTalents, NumTalentsDeathKnight, NumTalentsDemonHunter FROM num_talents_at_level" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_NUM_TALENTS_AT_LEVEL_MAX_ID, "SELECT MAX(ID) + 1 FROM num_talents_at_level");
            ...
            PrepareStatement(HotfixStatements.SEL_OVERRIDE_SPELL_DATA_MAX_ID, "SELECT MAX(ID) + 1 FROM override_spell_data");
            ...
            PrepareStatement(HotfixStatements.SEL_PARAGON_REPUTATION, "SELECT ID, FactionID, LevelThreshold, QuestID FROM paragon_reputation" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_PARAGON_REPUTATION_MAX_ID, "SELECT MAX(ID) + 1 FROM paragon_reputation");

            // Phase.db2
            PrepareStatement(HotfixStatements.SEL_PHASE, "SELECT ID, Flags FROM phase WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_PHASE_MAX_ID, "SELECT MAX(ID) + 1 FROM phase");
            ...
            PrepareStatement(HotfixStatements.SEL_PHASE_X_PHASE_GROUP_MAX_ID, "SELECT MAX(ID) + 1 FROM phase_x_phase_group");
            ...
            PrepareStatement(HotfixStatements.SEL_PLAYER_CONDITION_MAX_ID, "SELECT MAX(ID) + 1 FROM player_condition");
            ...
            PrepareStatement(HotfixStatements.SEL_POWER_DISPLAY, "SELECT ID, GlobalStringBaseTag, ActualType, Red, Green, Blue FROM power_display" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_POWER_DISPLAY_MAX_ID, "SELECT MAX(ID) + 1 FROM power_display");
            ...
            PrepareStatement(HotfixStatements.SEL_POWER_TYPE_MAX_ID, "SELECT MAX(ID) + 1 FROM power_type");
            ...
            PrepareStatement(HotfixStatements.SEL_PRESTIGE_LEVEL_INFO_MAX_ID, "SELECT MAX(ID) + 1 FROM prestige_level_info");
            ...
            PrepareStatement(HotfixStatements.SEL_PVP_DIFFICULTY_MAX_ID, "SELECT MAX(ID) + 1 FROM pvp_difficulty");

            // PvpItem.db2
            PrepareStatement(HotfixStatements.SEL_PVP_ITEM, "SELECT ID, ItemID, ItemLevelDelta FROM pvp_item WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_PVP_ITEM_MAX_ID, "SELECT MAX(ID) + 1 FROM pvp_item");

            // PvpStat.db2
            PrepareStatement(HotfixStatements.SEL_PVP_STAT, "SELECT Description, ID, MapID FROM pvp_stat WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_PVP_STAT_MAX_ID, "SELECT MAX(ID) + 1 FROM pvp_stat");
            ...
            PrepareStatement(HotfixStatements.SEL_PVP_SEASON, "SELECT ID, MilestoneSeason, AllianceAchievementID, HordeAchievementID FROM pvp_season" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_PVP_SEASON_MAX_ID, "SELECT MAX(ID) + 1 FROM pvp_season");
            ...
            PrepareStatement(HotfixStatements.SEL_PVP_TALENT_MAX_ID, "SELECT MAX(ID) + 1 FROM pvp_talent");
            ...
            PrepareStatement(HotfixStatements.SEL_PVP_TALENT_CATEGORY_MAX_ID, "SELECT MAX(ID) + 1 FROM pvp_talent_category");
            ...
            PrepareStatement(HotfixStatements.SEL_PVP_TALENT_SLOT_UNLOCK_MAX_ID, "SELECT MAX(ID) + 1 FROM pvp_talent_slot_unlock");
            ...
            PrepareStatement(HotfixStatements.SEL_PVP_TIER_MAX_ID, "SELECT MAX(ID) + 1 FROM pvp_tier");
            ...
            PrepareStatement(HotfixStatements.SEL_QUEST_FACTION_REWARD_MAX_ID, "SELECT MAX(ID) + 1 FROM quest_faction_reward");
            ...
            PrepareStatement(HotfixStatements.SEL_QUEST_INFO_MAX_ID, "SELECT MAX(ID) + 1 FROM quest_info");
            ...
            PrepareStatement(HotfixStatements.SEL_QUEST_LINE_X_QUEST, "SELECT ID, QuestLineID, QuestID, OrderIndex, Flags FROM quest_line_x_quest" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_QUEST_LINE_X_QUEST_MAX_ID, "SELECT MAX(ID) + 1 FROM quest_line_x_quest");
            ...
            PrepareStatement(HotfixStatements.SEL_QUEST_MONEY_REWARD_MAX_ID, "SELECT MAX(ID) + 1 FROM quest_money_reward");
            ...
            PrepareStatement(HotfixStatements.SEL_QUEST_PACKAGE_ITEM, "SELECT ID, PackageID, ItemID, ItemQuantity, DisplayType FROM quest_package_item" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_QUEST_PACKAGE_ITEM_MAX_ID, "SELECT MAX(ID) + 1 FROM quest_package_item");

            // QuestSort.db2
            PrepareStatement(HotfixStatements.SEL_QUEST_SORT, "SELECT ID, SortName, UiOrderIndex FROM quest_sort WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_QUEST_SORT_MAX_ID, "SELECT MAX(ID) + 1 FROM quest_sort");
            ...
            PrepareStatement(HotfixStatements.SEL_QUEST_V2_MAX_ID, "SELECT MAX(ID) + 1 FROM quest_v2");
            ...
            PrepareStatement(HotfixStatements.SEL_QUEST_XP_MAX_ID, "SELECT MAX(ID) + 1 FROM quest_xp");
            ...
            PrepareStatement(HotfixStatements.SEL_RAND_PROP_POINTS, "SELECT ID, DamageReplaceStatF, DamageSecondaryF, DamageReplaceStat, DamageSecondary, EpicF1, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_RAND_PROP_POINTS_MAX_ID, "SELECT MAX(ID) + 1 FROM rand_prop_points");
            ...
            PrepareStatement(HotfixStatements.SEL_REWARD_PACK_MAX_ID, "SELECT MAX(ID) + 1 FROM reward_pack");
            ...
            PrepareStatement(HotfixStatements.SEL_REWARD_PACK_X_CURRENCY_TYPE, "SELECT ID, CurrencyTypeID, Quantity, RewardPackID FROM reward_pack_x_currency_type" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_REWARD_PACK_X_CURRENCY_TYPE_MAX_ID, "SELECT MAX(ID) + 1 FROM reward_pack_x_currency_type");
            ...
            PrepareStatement(HotfixStatements.SEL_REWARD_PACK_X_ITEM, "SELECT ID, ItemID, ItemQuantity, RewardPackID FROM reward_pack_x_item" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_REWARD_PACK_X_ITEM_MAX_ID, "SELECT MAX(ID) + 1 FROM reward_pack_x_item");
            ...
            PrepareStatement(HotfixStatements.SEL_SCENARIO_MAX_ID, "SELECT MAX(ID) + 1 FROM scenario");
            ...
            PrepareStatement(HotfixStatements.SEL_SCENARIO_STEP_MAX_ID, "SELECT MAX(ID) + 1 FROM scenario_step");
            ...
            PrepareStatement(HotfixStatements.SEL_SCENE_SCRIPT, "SELECT ID, FirstSceneScriptID, NextSceneScriptID, Unknown915 FROM scene_script" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_SCENE_SCRIPT_MAX_ID, "SELECT MAX(ID) + 1 FROM scene_script");
            ...
            PrepareStatement(HotfixStatements.SEL_SCENE_SCRIPT_GLOBAL_TEXT_MAX_ID, "SELECT MAX(ID) + 1 FROM scene_script_global_text");
            ...
            PrepareStatement(HotfixStatements.SEL_SCENE_SCRIPT_PACKAGE_MAX_ID, "SELECT MAX(ID) + 1 FROM scene_script_package");
            ...
            PrepareStatement(HotfixStatements.SEL_SCENE_SCRIPT_TEXT_MAX_ID, "SELECT MAX(ID) + 1 FROM scene_script_text");

            // ServerMessages.db2
            PrepareStatement(HotfixStatements.SEL_SERVER_MESSAGES, "SELECT ID, `Text` FROM server_messages WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_SERVER_MESSAGES_MAX_ID, "SELECT MAX(ID) + 1 FROM server_messages");
            ...
            PrepareStatement(HotfixStatements.SEL_SKILL_LINE_MAX_ID, "SELECT MAX(ID) + 1 FROM skill_line");
            ...
            PrepareStatement(HotfixStatements.SEL_SKILL_LINE_ABILITY_MAX_ID, "SELECT MAX(ID) + 1 FROM skill_line_ability");
            ...
            PrepareStatement(HotfixStatements.SEL_SKILL_LINE_X_TRAIT_TREE, "SELECT ID, SkillLineID, TraitTreeID, OrderIndex FROM skill_line_x_trait_tree" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_SKILL_LINE_X_TRAIT_TREE_MAX_ID, "SELECT MAX(ID) + 1 FROM skill_line_x_trait_tree");
            ...
            PrepareStatement(HotfixStatements.SEL_SKILL_RACE_CLASS_INFO_MAX_ID, "SELECT MAX(ID) + 1 FROM skill_race_class_info");
            ...
            PrepareStatement(HotfixStatements.SEL_SOULBIND_CONDUIT_RANK_MAX_ID, "SELECT MAX(ID) + 1 FROM soulbind_conduit_rank");
            ...
            PrepareStatement(HotfixStatements.SEL_SOUND_KIT_MAX_ID, "SELECT MAX(ID) + 1 FROM sound_kit");
            ...
            PrepareStatement(HotfixStatements.SEL_SPECIALIZATION_SPELLS_MAX_ID, "SELECT MAX(ID) + 1 FROM specialization_spells");
            ...
            PrepareStatement(HotfixStatements.SEL_SPEC_SET_MEMBER_MAX_ID, "SELECT MAX(ID) + 1 FROM spec_set_member");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_AURA_OPTIONS_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_aura_options");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_AURA_RESTRICTIONS_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_aura_restrictions");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_CAST_TIMES_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_cast_times");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_CASTING_REQUIREMENTS_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_casting_requirements");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_CATEGORIES_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_categories");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_CATEGORY, "SELECT ID, Name, Flags, UsesPerWeek, MaxCharges, ChargeRecoveryTime, TypeMask FROM spell_category" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_SPELL_CATEGORY_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_category");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_CLASS_OPTIONS_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_class_options");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_COOLDOWNS_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_cooldowns");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_DURATION_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_duration");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_EFFECT_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_effect");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_EQUIPPED_ITEMS_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_equipped_items");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_FOCUS_OBJECT_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_focus_object");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_INTERRUPTS_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_interrupts");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_ITEM_ENCHANTMENT, "SELECT ID, Name, HordeName, Duration, EffectArg1, EffectArg2, EffectArg3, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_SPELL_ITEM_ENCHANTMENT_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_item_enchantment");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_ITEM_ENCHANTMENT_CONDITION_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_item_enchantment_condition");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_KEYBOUND_OVERRIDE, "SELECT ID, `Function`, Type, Data, Flags FROM spell_keybound_override" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_SPELL_KEYBOUND_OVERRIDE_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_keybound_override");

            // SpellLabel.db2
            PrepareStatement(HotfixStatements.SEL_SPELL_LABEL, "SELECT ID, LabelID, SpellID FROM spell_label WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_SPELL_LABEL_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_label");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_LEARN_SPELL, "SELECT ID, SpellID, LearnSpellID, OverridesSpellID FROM spell_learn_spell" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_SPELL_LEARN_SPELL_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_learn_spell");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_LEVELS_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_levels");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_MISC, "SELECT ID, Attributes1, Attributes2, Attributes3, Attributes4, Attributes5, Attributes6, Attributes7, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_SPELL_MISC_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_misc");

            // SpellName.db2
            PrepareStatement(HotfixStatements.SEL_SPELL_NAME, "SELECT ID, Name FROM spell_name WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_SPELL_NAME_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_name");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_POWER, "SELECT ID, OrderIndex, ManaCost, ManaCostPerLevel, ManaPerSecond, PowerDisplayID, AltPowerBarID, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_SPELL_POWER_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_power");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_POWER_DIFFICULTY, "SELECT ID, DifficultyID, OrderIndex FROM spell_power_difficulty" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_SPELL_POWER_DIFFICULTY_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_power_difficulty");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_PROCS_PER_MINUTE_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_procs_per_minute");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_PROCS_PER_MINUTE_MOD, "SELECT ID, Type, Param, Coeff, SpellProcsPerMinuteID FROM spell_procs_per_minute_mod" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_SPELL_PROCS_PER_MINUTE_MOD_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_procs_per_minute_mod");

            // SpellRadius.db2
            PrepareStatement(HotfixStatements.SEL_SPELL_RADIUS, "SELECT ID, Radius, RadiusPerLevel, RadiusMin, RadiusMax FROM spell_radius" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_SPELL_RADIUS_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_radius");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_RANGE_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_range");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_REAGENTS_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_reagents");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_REAGENTS_CURRENCY, "SELECT ID, SpellID, CurrencyTypesID, CurrencyCount FROM spell_reagents_currency" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_SPELL_REAGENTS_CURRENCY_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_reagents_currency");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_SCALING, "SELECT ID, SpellID, MinScalingLevel, MaxScalingLevel, ScalesFromItemLevel FROM spell_scaling" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_SPELL_SCALING_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_scaling");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_SHAPESHIFT_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_shapeshift");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_SHAPESHIFT_FORM_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_shapeshift_form");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_TARGET_RESTRICTIONS_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_target_restrictions");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_TOTEMS_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_totems");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_VISUAL, "SELECT ID, MissileCastOffset1, MissileCastOffset2, MissileCastOffset3, MissileImpactOffset1, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_SPELL_VISUAL_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_visual");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_VISUAL_EFFECT_NAME_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_visual_effect_name");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_VISUAL_MISSILE_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_visual_missile");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_VISUAL_KIT_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_visual_kit");
            ...
            PrepareStatement(HotfixStatements.SEL_SPELL_X_SPELL_VISUAL_MAX_ID, "SELECT MAX(ID) + 1 FROM spell_x_spell_visual");
            ...
            PrepareStatement(HotfixStatements.SEL_SUMMON_PROPERTIES, "SELECT ID, Control, Faction, Title, Slot, Flags1, Flags2 FROM summon_properties" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_SUMMON_PROPERTIES_MAX_ID, "SELECT MAX(ID) + 1 FROM summon_properties");
            ...
            PrepareStatement(HotfixStatements.SEL_TACT_KEY_MAX_ID, "SELECT MAX(ID) + 1 FROM tact_key");
            ...
            PrepareStatement(HotfixStatements.SEL_TALENT_MAX_ID, "SELECT MAX(ID) + 1 FROM talent");
            ...
            PrepareStatement(HotfixStatements.SEL_TAXI_NODES_MAX_ID, "SELECT MAX(ID) + 1 FROM taxi_nodes");
            ...
            PrepareStatement(HotfixStatements.SEL_TAXI_PATH_MAX_ID, "SELECT MAX(ID) + 1 FROM taxi_path");
            ...
            PrepareStatement(HotfixStatements.SEL_TAXI_PATH_NODE_MAX_ID, "SELECT MAX(ID) + 1 FROM taxi_path_node");
            ...
            PrepareStatement(HotfixStatements.SEL_TOTEM_CATEGORY, "SELECT ID, Name, TotemCategoryType, TotemCategoryMask FROM totem_category" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_TOTEM_CATEGORY_MAX_ID, "SELECT MAX(ID) + 1 FROM totem_category");
            ...
            PrepareStatement(HotfixStatements.SEL_TOY_MAX_ID, "SELECT MAX(ID) + 1 FROM toy");
            ...
            PrepareStatement(HotfixStatements.SEL_TRANSMOG_HOLIDAY_MAX_ID, "SELECT MAX(ID) + 1 FROM transmog_holiday");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_COND, "SELECT ID, CondType, TraitTreeID, GrantedRanks, QuestID, AchievementID, SpecSetID, TraitNodeGroupID, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_TRAIT_COND_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_cond");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_COST_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_cost");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_CURRENCY_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_currency");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_CURRENCY_SOURCE_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_currency_source");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_DEFINITION_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_definition");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_DEFINITION_EFFECT_POINTS_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_definition_effect_points");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_EDGE, "SELECT ID, VisualStyle, LeftTraitNodeID, RightTraitNodeID, Type FROM trait_edge" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_TRAIT_EDGE_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_edge");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_node");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_ENTRY, "SELECT ID, TraitDefinitionID, MaxRanks, NodeEntryType FROM trait_node_entry" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_ENTRY_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_node_entry");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_ENTRY_X_TRAIT_COND, "SELECT ID, TraitCondID, TraitNodeEntryID FROM trait_node_entry_x_trait_cond" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_ENTRY_X_TRAIT_COND_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_node_entry_x_trait_cond");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_ENTRY_X_TRAIT_COST, "SELECT ID, TraitNodeEntryID, TraitCostID FROM trait_node_entry_x_trait_cost" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_ENTRY_X_TRAIT_COST_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_node_entry_x_trait_cost");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_GROUP_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_node_group");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_GROUP_X_TRAIT_COND, "SELECT ID, TraitCondID, TraitNodeGroupID FROM trait_node_group_x_trait_cond" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_GROUP_X_TRAIT_COND_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_node_group_x_trait_cond");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_GROUP_X_TRAIT_COST, "SELECT ID, TraitNodeGroupID, TraitCostID FROM trait_node_group_x_trait_cost" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_GROUP_X_TRAIT_COST_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_node_group_x_trait_cost");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_GROUP_X_TRAIT_NODE, "SELECT ID, TraitNodeGroupID, TraitNodeID, `Index` FROM trait_node_group_x_trait_node" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_GROUP_X_TRAIT_NODE_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_node_group_x_trait_node");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_X_TRAIT_COND, "SELECT ID, TraitCondID, TraitNodeID FROM trait_node_x_trait_cond" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_X_TRAIT_COND_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_node_x_trait_cond");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_X_TRAIT_COST, "SELECT ID, TraitNodeID, TraitCostID FROM trait_node_x_trait_cost" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_X_TRAIT_COST_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_node_x_trait_cost");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_X_TRAIT_NODE_ENTRY, "SELECT ID, TraitNodeID, TraitNodeEntryID, `Index` FROM trait_node_x_trait_node_entry" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_TRAIT_NODE_X_TRAIT_NODE_ENTRY_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_node_x_trait_node_entry");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_TREE_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_tree");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_TREE_LOADOUT, "SELECT ID, TraitTreeID, ChrSpecializationID FROM trait_tree_loadout" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_TRAIT_TREE_LOADOUT_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_tree_loadout");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_TREE_LOADOUT_ENTRY_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_tree_loadout_entry");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_TREE_X_TRAIT_COST, "SELECT ID, TraitTreeID, TraitCostID FROM trait_tree_x_trait_cost" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_TRAIT_TREE_X_TRAIT_COST_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_tree_x_trait_cost");
            ...
            PrepareStatement(HotfixStatements.SEL_TRAIT_TREE_X_TRAIT_CURRENCY, "SELECT ID, `Index`, TraitTreeID, TraitCurrencyID FROM trait_tree_x_trait_currency" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_TRAIT_TREE_X_TRAIT_CURRENCY_MAX_ID, "SELECT MAX(ID) + 1 FROM trait_tree_x_trait_currency");
            ...
            PrepareStatement(HotfixStatements.SEL_TRANSMOG_ILLUSION, "SELECT ID, UnlockConditionID, TransmogCost, SpellItemEnchantmentID, Flags FROM transmog_illusion" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_TRANSMOG_ILLUSION_MAX_ID, "SELECT MAX(ID) + 1 FROM transmog_illusion");
            ...
            PrepareStatement(HotfixStatements.SEL_TRANSMOG_SET_MAX_ID, "SELECT MAX(ID) + 1 FROM transmog_set");
            ...
            PrepareStatement(HotfixStatements.SEL_TRANSMOG_SET_GROUP_MAX_ID, "SELECT MAX(ID) + 1 FROM transmog_set_group");
            ...
            PrepareStatement(HotfixStatements.SEL_TRANSMOG_SET_ITEM, "SELECT ID, TransmogSetID, ItemModifiedAppearanceID, Flags FROM transmog_set_item" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_TRANSMOG_SET_ITEM_MAX_ID, "SELECT MAX(ID) + 1 FROM transmog_set_item");
            ...
            PrepareStatement(HotfixStatements.SEL_TRANSPORT_ANIMATION, "SELECT ID, PosX, PosY, PosZ, SequenceID, TimeIndex, TransportID FROM transport_animation" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_TRANSPORT_ANIMATION_MAX_ID, "SELECT MAX(ID) + 1 FROM transport_animation");
            ...
            PrepareStatement(HotfixStatements.SEL_TRANSPORT_ROTATION, "SELECT ID, Rot1, Rot2, Rot3, Rot4, TimeIndex, GameObjectsID FROM transport_rotation" +
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_TRANSPORT_ROTATION_MAX_ID, "SELECT MAX(ID) + 1 FROM transport_rotation");
            ...
            PrepareStatement(HotfixStatements.SEL_UI_MAP, "SELECT Name, ID, ParentUiMapID, Flags, `System`, Type, BountySetID, BountyDisplayLocation, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_UI_MAP_MAX_ID, "SELECT MAX(ID) + 1 FROM ui_map");
            ...
            PrepareStatement(HotfixStatements.SEL_UI_MAP_ASSIGNMENT_MAX_ID, "SELECT MAX(ID) + 1 FROM ui_map_assignment");
            ...
            PrepareStatement(HotfixStatements.SEL_UI_MAP_LINK_MAX_ID, "SELECT MAX(ID) + 1 FROM ui_map_link");
            ...
            PrepareStatement(HotfixStatements.SEL_UI_MAP_X_MAP_ART_MAX_ID, "SELECT MAX(ID) + 1 FROM ui_map_x_map_art");
            ...
            PrepareStatement(HotfixStatements.SEL_UI_SPLASH_SCREEN_MAX_ID, "SELECT MAX(ID) + 1 FROM ui_splash_screen");
            ...
            PrepareStatement(HotfixStatements.SEL_UNIT_CONDITION, "SELECT ID, Flags, Variable1, Variable2, Variable3, Variable4, Variable5, Variable6, Variable7, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_UNIT_CONDITION_MAX_ID, "SELECT MAX(ID) + 1 FROM unit_condition");
            ...
            PrepareStatement(HotfixStatements.SEL_UNIT_POWER_BAR_MAX_ID, "SELECT MAX(ID) + 1 FROM unit_power_bar");
            ...
            PrepareStatement(HotfixStatements.SEL_VEHICLE_MAX_ID, "SELECT MAX(ID) + 1 FROM vehicle");
            ...
            PrepareStatement(HotfixStatements.SEL_VEHICLE_SEAT, "SELECT ID, AttachmentOffsetX, AttachmentOffsetY, AttachmentOffsetZ, CameraOffsetX, CameraOffsetY, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_VEHICLE_SEAT_MAX_ID, "SELECT MAX(ID) + 1 FROM vehicle_seat");
            ...
            PrepareStatement(HotfixStatements.SEL_WMO_AREA_TABLE, "SELECT AreaName, ID, WmoID, NameSetID, WmoGroupID, SoundProviderPref, SoundProviderPrefUnderwater, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_WMO_AREA_TABLE_MAX_ID, "SELECT MAX(ID) + 1 FROM wmo_area_table");
            ...
            PrepareStatement(HotfixStatements.SEL_WORLD_EFFECT_MAX_ID, "SELECT MAX(ID) + 1 FROM world_effect");
            ...
            PrepareStatement(HotfixStatements.SEL_WORLD_MAP_OVERLAY, "SELECT ID, UiMapArtID, TextureWidth, TextureHeight, OffsetX, OffsetY, HitRectTop, HitRectBottom, " +
                ...
                " WHERE (`VerifiedBuild` > 0) = ?");
            PrepareStatement(HotfixStatements.SEL_WORLD_MAP_OVERLAY_MAX_ID, "SELECT MAX(ID) + 1 FROM world_map_overlay");
            ...
            PrepareStatement(HotfixStatements.SEL_WORLD_STATE_EXPRESSION_MAX_ID, "SELECT MAX(ID) + 1 FROM world_state_expression");
        }
    }

    public enum HotfixStatements : UInt32
    {
        //None = 0,

        SEL_ACHIEVEMENT,
        SEL_ACHIEVEMENT_MAX_ID,
        SEL_ACHIEVEMENT_LOCALE,

        SEL_ACHIEVEMENT_CATEGORY,
        SEL_ACHIEVEMENT_CATEGORY_MAX_ID,
        SEL_ACHIEVEMENT_CATEGORY_LOCALE,

        SEL_ADVENTURE_JOURNAL,
        SEL_ADVENTURE_JOURNAL_MAX_ID,
        SEL_ADVENTURE_JOURNAL_LOCALE,

        SEL_ADVENTURE_MAP_POI,
        SEL_ADVENTURE_MAP_POI_MAX_ID,
        SEL_ADVENTURE_MAP_POI_LOCALE,

        SEL_ANIMATION_DATA,
        SEL_ANIMATION_DATA_MAX_ID,

        SEL_ANIM_KIT,
        SEL_ANIM_KIT_MAX_ID,

        SEL_AREA_GROUP_MEMBER,
        SEL_AREA_GROUP_MEMBER_MAX_ID,

        SEL_AREA_TABLE,
        SEL_AREA_TABLE_MAX_ID,
        SEL_AREA_TABLE_LOCALE,

        SEL_AREA_TRIGGER,
        SEL_AREA_TRIGGER_MAX_ID,

        SEL_ARMOR_LOCATION,
        SEL_ARMOR_LOCATION_MAX_ID,
        ...
        SEL_ARTIFACT_APPEARANCE_MAX_ID,
        SEL_ARTIFACT_APPEARANCE_LOCALE,

        SEL_ARTIFACT_APPEARANCE_SET,
        SEL_ARTIFACT_APPEARANCE_SET_MAX_ID,
        SEL_ARTIFACT_APPEARANCE_SET_LOCALE,

        SEL_ARTIFACT_CATEGORY,
        SEL_ARTIFACT_CATEGORY_MAX_ID,

        SEL_ARTIFACT_POWER,
        SEL_ARTIFACT_POWER_MAX_ID,

        SEL_ARTIFACT_POWER_LINK,
        SEL_ARTIFACT_POWER_LINK_MAX_ID,

        SEL_ARTIFACT_POWER_PICKER,
        SEL_ARTIFACT_POWER_PICKER_MAX_ID,

        SEL_ARTIFACT_POWER_RANK,
        SEL_ARTIFACT_POWER_RANK_MAX_ID,

        SEL_ARTIFACT_QUEST_XP,
        SEL_ARTIFACT_QUEST_XP_MAX_ID,

        SEL_ARTIFACT_TIER,
        SEL_ARTIFACT_TIER_MAX_ID,

        SEL_ARTIFACT_UNLOCK,
        SEL_ARTIFACT_UNLOCK_MAX_ID,

        SEL_AUCTION_HOUSE,
        SEL_AUCTION_HOUSE_MAX_ID,
        SEL_AUCTION_HOUSE_LOCALE,

        SEL_AZERITE_EMPOWERED_ITEM,
        SEL_AZERITE_EMPOWERED_ITEM_MAX_ID,

        SEL_AZERITE_ESSENCE,
        SEL_AZERITE_ESSENCE_MAX_ID,
        SEL_AZERITE_ESSENCE_LOCALE,

        SEL_AZERITE_ESSENCE_POWER,
        SEL_AZERITE_ESSENCE_POWER_MAX_ID,
        SEL_AZERITE_ESSENCE_POWER_LOCALE,

        SEL_AZERITE_ITEM,
        SEL_AZERITE_ITEM_MAX_ID,

        SEL_AZERITE_ITEM_MILESTONE_POWER,
        SEL_AZERITE_ITEM_MILESTONE_POWER_MAX_ID,

        SEL_AZERITE_KNOWLEDGE_MULTIPLIER,
        SEL_AZERITE_KNOWLEDGE_MULTIPLIER_MAX_ID,

        SEL_AZERITE_LEVEL_INFO,
        SEL_AZERITE_LEVEL_INFO_MAX_ID,

        SEL_AZERITE_POWER,
        SEL_AZERITE_POWER_MAX_ID,

        SEL_AZERITE_POWER_SET_MEMBER,
        SEL_AZERITE_POWER_SET_MEMBER_MAX_ID,

        SEL_AZERITE_TIER_UNLOCK,
        SEL_AZERITE_TIER_UNLOCK_MAX_ID,

        SEL_AZERITE_TIER_UNLOCK_SET,
        SEL_AZERITE_TIER_UNLOCK_SET_MAX_ID,

        SEL_AZERITE_UNLOCK_MAPPING,
        SEL_AZERITE_UNLOCK_MAPPING_MAX_ID,

        SEL_BANK_BAG_SLOT_PRICES,
        SEL_BANK_BAG_SLOT_PRICES_MAX_ID,

        SEL_BANNED_ADDONS,
        SEL_BANNED_ADDONS_MAX_ID,

        SEL_BARBER_SHOP_STYLE,
        SEL_BARBER_SHOP_STYLE_MAX_ID,
        SEL_BARBER_SHOP_STYLE_LOCALE,

        SEL_BATTLE_PET_ABILITY,
        SEL_BATTLE_PET_ABILITY_MAX_ID,
        SEL_BATTLE_PET_ABILITY_LOCALE,

        SEL_BATTLE_PET_BREED_QUALITY,
        SEL_BATTLE_PET_BREED_QUALITY_MAX_ID,

        SEL_BATTLE_PET_BREED_STATE,
        SEL_BATTLE_PET_BREED_STATE_MAX_ID,

        SEL_BATTLE_PET_SPECIES,
        SEL_BATTLE_PET_SPECIES_MAX_ID,
        SEL_BATTLE_PET_SPECIES_LOCALE,

        SEL_BATTLE_PET_SPECIES_STATE,
        SEL_BATTLE_PET_SPECIES_STATE_MAX_ID,

        SEL_BATTLEMASTER_LIST,
        SEL_BATTLEMASTER_LIST_MAX_ID,
        SEL_BATTLEMASTER_LIST_LOCALE,

        SEL_BROADCAST_TEXT,
        SEL_BROADCAST_TEXT_MAX_ID,
        SEL_BROADCAST_TEXT_LOCALE,

        SEL_BROADCAST_TEXT_DURATION,
        SEL_BROADCAST_TEXT_DURATION_MAX_ID,

        SEL_CFG_CATEGORIES,
        SEL_CFG_CATEGORIES_MAX_ID,
        SEL_CFG_CATEGORIES_LOCALE,

        SEL_CFG_REGIONS,
        SEL_CFG_REGIONS_MAX_ID,

        SEL_CHALLENGE_MODE_ITEM_BONUS_OVERRIDE,
        SEL_CHALLENGE_MODE_ITEM_BONUS_OVERRIDE_MAX_ID,

        SEL_CHAR_TITLES,
        SEL_CHAR_TITLES_MAX_ID,
        SEL_CHAR_TITLES_LOCALE,

        SEL_CHARACTER_LOADOUT,
        SEL_CHARACTER_LOADOUT_MAX_ID,

        SEL_CHARACTER_LOADOUT_ITEM,
        SEL_CHARACTER_LOADOUT_ITEM_MAX_ID,

        SEL_CHAT_CHANNELS,
        SEL_CHAT_CHANNELS_MAX_ID,
        SEL_CHAT_CHANNELS_LOCALE,

        SEL_CHR_CLASS_UI_DISPLAY,
        SEL_CHR_CLASS_UI_DISPLAY_MAX_ID,

        SEL_CHR_CLASSES,
        SEL_CHR_CLASSES_MAX_ID,
        SEL_CHR_CLASSES_LOCALE,

        SEL_CHR_CLASSES_X_POWER_TYPES,
        SEL_CHR_CLASSES_X_POWER_TYPES_MAX_ID,

        SEL_CHR_CUSTOMIZATION_CHOICE,
        SEL_CHR_CUSTOMIZATION_CHOICE_MAX_ID,
        SEL_CHR_CUSTOMIZATION_CHOICE_LOCALE,

        SEL_CHR_CUSTOMIZATION_DISPLAY_INFO,
        SEL_CHR_CUSTOMIZATION_DISPLAY_INFO_MAX_ID,

        SEL_CHR_CUSTOMIZATION_ELEMENT,
        SEL_CHR_CUSTOMIZATION_ELEMENT_MAX_ID,

        SEL_CHR_CUSTOMIZATION_OPTION,
        SEL_CHR_CUSTOMIZATION_OPTION_MAX_ID,
        SEL_CHR_CUSTOMIZATION_OPTION_LOCALE,

        SEL_CHR_CUSTOMIZATION_REQ,
        SEL_CHR_CUSTOMIZATION_REQ_MAX_ID,
        SEL_CHR_CUSTOMIZATION_REQ_LOCALE,

        SEL_CHR_CUSTOMIZATION_REQ_CHOICE,
        SEL_CHR_CUSTOMIZATION_REQ_CHOICE_MAX_ID,

        SEL_CHR_MODEL,
        SEL_CHR_MODEL_MAX_ID,

        SEL_CHR_RACE_X_CHR_MODEL,
        SEL_CHR_RACE_X_CHR_MODEL_MAX_ID,

        SEL_CHR_RACES,
        SEL_CHR_RACES_MAX_ID,
        SEL_CHR_RACES_LOCALE,

        SEL_CHR_SPECIALIZATION,
        SEL_CHR_SPECIALIZATION_MAX_ID,
        SEL_CHR_SPECIALIZATION_LOCALE,

        SEL_CINEMATIC_CAMERA,
        SEL_CINEMATIC_CAMERA_MAX_ID,

        SEL_CINEMATIC_SEQUENCES,
        SEL_CINEMATIC_SEQUENCES_MAX_ID,

        SEL_CONDITIONAL_CHR_MODEL,
        SEL_CONDITIONAL_CHR_MODEL_MAX_ID,

        SEL_CONDITIONAL_CONTENT_TUNING,
        SEL_CONDITIONAL_CONTENT_TUNING_MAX_ID,

        SEL_CONTENT_TUNING,
        SEL_CONTENT_TUNING_MAX_ID,

        SEL_CONTENT_TUNING_X_EXPECTED,
        SEL_CONTENT_TUNING_X_EXPECTED_MAX_ID,

        SEL_CONTENT_TUNING_X_LABEL,
        SEL_CONTENT_TUNING_X_LABEL_MAX_ID,

        SEL_CONVERSATION_LINE,
        SEL_CONVERSATION_LINE_MAX_ID,

        SEL_CORRUPTION_EFFECTS,
        SEL_CORRUPTION_EFFECTS_MAX_ID,

        SEL_CREATURE_DISPLAY_INFO,
        SEL_CREATURE_DISPLAY_INFO_MAX_ID,

        SEL_CREATURE_DISPLAY_INFO_EXTRA,
        SEL_CREATURE_DISPLAY_INFO_EXTRA_MAX_ID,

        SEL_CREATURE_FAMILY,
        SEL_CREATURE_FAMILY_MAX_ID,
        SEL_CREATURE_FAMILY_LOCALE,

        SEL_CREATURE_MODEL_DATA,
        SEL_CREATURE_MODEL_DATA_MAX_ID,

        SEL_CREATURE_TYPE,
        SEL_CREATURE_TYPE_MAX_ID,
        ...
        SEL_CRITERIA_TREE,
        SEL_CRITERIA_TREE_MAX_ID,
        SEL_CRITERIA_TREE_LOCALE,

        SEL_CURRENCY_CONTAINER,
        SEL_CURRENCY_CONTAINER_MAX_ID,
        SEL_CURRENCY_CONTAINER_LOCALE,

        SEL_CURRENCY_TYPES,
        SEL_CURRENCY_TYPES_MAX_ID,
        ...
        SEL_CURVE_POINT,
        SEL_CURVE_POINT_MAX_ID,

        SEL_DESTRUCTIBLE_MODEL_DATA,
        SEL_DESTRUCTIBLE_MODEL_DATA_MAX_ID,

        SEL_DIFFICULTY,
        SEL_DIFFICULTY_MAX_ID,
        SEL_DIFFICULTY_LOCALE,

        SEL_DUNGEON_ENCOUNTER,
        SEL_DUNGEON_ENCOUNTER_MAX_ID,
        SEL_DUNGEON_ENCOUNTER_LOCALE,

        SEL_DURABILITY_COSTS,
        SEL_DURABILITY_COSTS_MAX_ID,

        SEL_DURABILITY_QUALITY,
        SEL_DURABILITY_QUALITY_MAX_ID,

        SEL_EMOTES,
        SEL_EMOTES_MAX_ID,

        SEL_EMOTES_TEXT,
        SEL_EMOTES_TEXT_MAX_ID,

        SEL_EMOTES_TEXT_SOUND,
        SEL_EMOTES_TEXT_SOUND_MAX_ID,

        SEL_EXPECTED_STAT,
        SEL_EXPECTED_STAT_MAX_ID,

        SEL_EXPECTED_STAT_MOD,
        SEL_EXPECTED_STAT_MOD_MAX_ID,
        ...
        SEL_FACTION_TEMPLATE_MAX_ID,

        SEL_FRIENDSHIP_REP_REACTION,
        SEL_FRIENDSHIP_REP_REACTION_MAX_ID,
        SEL_FRIENDSHIP_REP_REACTION_LOCALE,

        SEL_FRIENDSHIP_REPUTATION,
        SEL_FRIENDSHIP_REPUTATION_MAX_ID,
        SEL_FRIENDSHIP_REPUTATION_LOCALE,

        SEL_GAMEOBJECT_ART_KIT,
        SEL_GAMEOBJECT_ART_KIT_MAX_ID,

        SEL_GAMEOBJECT_DISPLAY_INFO,
        SEL_GAMEOBJECT_DISPLAY_INFO_MAX_ID,

        SEL_GAMEOBJECTS,
        SEL_GAMEOBJECTS_MAX_ID,
        SEL_GAMEOBJECTS_LOCALE,

        SEL_GARR_ABILITY,
        SEL_GARR_ABILITY_MAX_ID,
        SEL_GARR_ABILITY_LOCALE,

        SEL_GARR_BUILDING,
        SEL_GARR_BUILDING_MAX_ID,
        SEL_GARR_BUILDING_LOCALE,

        SEL_GARR_BUILDING_PLOT_INST,
        SEL_GARR_BUILDING_PLOT_INST_MAX_ID,

        SEL_GARR_CLASS_SPEC,
        SEL_GARR_CLASS_SPEC_MAX_ID,
        SEL_GARR_CLASS_SPEC_LOCALE,

        SEL_GARR_FOLLOWER,
        SEL_GARR_FOLLOWER_MAX_ID,
        SEL_GARR_FOLLOWER_LOCALE,

        SEL_GARR_FOLLOWER_X_ABILITY,
        SEL_GARR_FOLLOWER_X_ABILITY_MAX_ID,

        SEL_GARR_MISSION,
        SEL_GARR_MISSION_MAX_ID,
        SEL_GARR_MISSION_LOCALE,

        SEL_GARR_PLOT,
        SEL_GARR_PLOT_MAX_ID,

        SEL_GARR_PLOT_BUILDING,
        SEL_GARR_PLOT_BUILDING_MAX_ID,

        SEL_GARR_PLOT_INSTANCE,
        SEL_GARR_PLOT_INSTANCE_MAX_ID,

        SEL_GARR_SITE_LEVEL,
        SEL_GARR_SITE_LEVEL_MAX_ID,

        SEL_GARR_SITE_LEVEL_PLOT_INST,
        SEL_GARR_SITE_LEVEL_PLOT_INST_MAX_ID,

        SEL_GARR_TALENT_TREE,
        SEL_GARR_TALENT_TREE_MAX_ID,
        SEL_GARR_TALENT_TREE_LOCALE,

        SEL_GEM_PROPERTIES,
        SEL_GEM_PROPERTIES_MAX_ID,

        SEL_GLOBAL_CURVE,
        SEL_GLOBAL_CURVE_MAX_ID,

        SEL_GLYPH_BINDABLE_SPELL,
        SEL_GLYPH_BINDABLE_SPELL_MAX_ID,

        SEL_GLYPH_PROPERTIES,
        SEL_GLYPH_PROPERTIES_MAX_ID,

        SEL_GLYPH_REQUIRED_SPEC,
        SEL_GLYPH_REQUIRED_SPEC_MAX_ID,

        SEL_GOSSIP_NPC_OPTION,
        SEL_GOSSIP_NPC_OPTION_MAX_ID,

        SEL_GUILD_COLOR_BACKGROUND,
        SEL_GUILD_COLOR_BACKGROUND_MAX_ID,

        SEL_GUILD_COLOR_BORDER,
        SEL_GUILD_COLOR_BORDER_MAX_ID,

        SEL_GUILD_COLOR_EMBLEM,
        SEL_GUILD_COLOR_EMBLEM_MAX_ID,

        SEL_GUILD_PERK_SPELLS,
        SEL_GUILD_PERK_SPELLS_MAX_ID,
        ...
        SEL_IMPORT_PRICE_ARMOR_MAX_ID,

        SEL_IMPORT_PRICE_QUALITY,
        SEL_IMPORT_PRICE_QUALITY_MAX_ID,

        SEL_IMPORT_PRICE_SHIELD,
        SEL_IMPORT_PRICE_SHIELD_MAX_ID,

        SEL_IMPORT_PRICE_WEAPON,
        SEL_IMPORT_PRICE_WEAPON_MAX_ID,

        SEL_ITEM,
        SEL_ITEM_MAX_ID,

        SEL_ITEM_APPEARANCE,
        SEL_ITEM_APPEARANCE_MAX_ID,

        SEL_ITEM_ARMOR_QUALITY,
        SEL_ITEM_ARMOR_QUALITY_MAX_ID,

        SEL_ITEM_ARMOR_SHIELD,
        SEL_ITEM_ARMOR_SHIELD_MAX_ID,

        SEL_ITEM_ARMOR_TOTAL,
        SEL_ITEM_ARMOR_TOTAL_MAX_ID,

        SEL_ITEM_BAG_FAMILY,
        SEL_ITEM_BAG_FAMILY_MAX_ID,
        SEL_ITEM_BAG_FAMILY_LOCALE,

        SEL_ITEM_BONUS,
        SEL_ITEM_BONUS_MAX_ID,

        SEL_ITEM_BONUS_LIST_GROUP_ENTRY,
        SEL_ITEM_BONUS_LIST_GROUP_ENTRY_MAX_ID,

        SEL_ITEM_BONUS_LIST_LEVEL_DELTA,
        SEL_ITEM_BONUS_LIST_LEVEL_DELTA_MAX_ID,

        SEL_ITEM_BONUS_TREE,
        SEL_ITEM_BONUS_TREE_MAX_ID,

        SEL_ITEM_BONUS_TREE_NODE,
        SEL_ITEM_BONUS_TREE_NODE_MAX_ID,

        SEL_ITEM_CHILD_EQUIPMENT,
        SEL_ITEM_CHILD_EQUIPMENT_MAX_ID,

        SEL_ITEM_CLASS,
        SEL_ITEM_CLASS_MAX_ID,
        SEL_ITEM_CLASS_LOCALE,

        SEL_ITEM_CONTEXT_PICKER_ENTRY,
        SEL_ITEM_CONTEXT_PICKER_ENTRY_MAX_ID,

        SEL_ITEM_CURRENCY_COST,
        SEL_ITEM_CURRENCY_COST_MAX_ID,

        SEL_ITEM_DAMAGE_AMMO,
        SEL_ITEM_DAMAGE_AMMO_MAX_ID,

        SEL_ITEM_DAMAGE_ONE_HAND,
        SEL_ITEM_DAMAGE_ONE_HAND_MAX_ID,

        SEL_ITEM_DAMAGE_ONE_HAND_CASTER,
        SEL_ITEM_DAMAGE_ONE_HAND_CASTER_MAX_ID,

        SEL_ITEM_DAMAGE_TWO_HAND,
        SEL_ITEM_DAMAGE_TWO_HAND_MAX_ID,

        SEL_ITEM_DAMAGE_TWO_HAND_CASTER,
        SEL_ITEM_DAMAGE_TWO_HAND_CASTER_MAX_ID,

        SEL_ITEM_DISENCHANT_LOOT,
        SEL_ITEM_DISENCHANT_LOOT_MAX_ID,

        SEL_ITEM_EFFECT,
        SEL_ITEM_EFFECT_MAX_ID,

        SEL_ITEM_EXTENDED_COST,
        SEL_ITEM_EXTENDED_COST_MAX_ID,

        SEL_ITEM_LEVEL_SELECTOR,
        SEL_ITEM_LEVEL_SELECTOR_MAX_ID,

        SEL_ITEM_LEVEL_SELECTOR_QUALITY,
        SEL_ITEM_LEVEL_SELECTOR_QUALITY_MAX_ID,

        SEL_ITEM_LEVEL_SELECTOR_QUALITY_SET,
        SEL_ITEM_LEVEL_SELECTOR_QUALITY_SET_MAX_ID,

        SEL_ITEM_LIMIT_CATEGORY,
        SEL_ITEM_LIMIT_CATEGORY_MAX_ID,
        SEL_ITEM_LIMIT_CATEGORY_LOCALE,

        SEL_ITEM_LIMIT_CATEGORY_CONDITION,
        SEL_ITEM_LIMIT_CATEGORY_CONDITION_MAX_ID,

        SEL_ITEM_MODIFIED_APPEARANCE,
        SEL_ITEM_MODIFIED_APPEARANCE_MAX_ID,

        SEL_ITEM_MODIFIED_APPEARANCE_EXTRA,
        SEL_ITEM_MODIFIED_APPEARANCE_EXTRA_MAX_ID,

        SEL_ITEM_NAME_DESCRIPTION,
        SEL_ITEM_NAME_DESCRIPTION_MAX_ID,
        SEL_ITEM_NAME_DESCRIPTION_LOCALE,

        SEL_ITEM_PRICE_BASE,
        SEL_ITEM_PRICE_BASE_MAX_ID,

        SEL_ITEM_SEARCH_NAME,
        SEL_ITEM_SEARCH_NAME_MAX_ID,
        ...
        SEL_ITEM_SET_SPELL,
        SEL_ITEM_SET_SPELL_MAX_ID,

        SEL_ITEM_SPARSE,
        SEL_ITEM_SPARSE_MAX_ID,
        SEL_ITEM_SPARSE_LOCALE,

        SEL_ITEM_SPEC,
        SEL_ITEM_SPEC_MAX_ID,

        SEL_ITEM_SPEC_OVERRIDE,
        SEL_ITEM_SPEC_OVERRIDE_MAX_ID,

        SEL_ITEM_X_BONUS_TREE,
        SEL_ITEM_X_BONUS_TREE_MAX_ID,

        SEL_ITEM_X_ITEM_EFFECT,
        SEL_ITEM_X_ITEM_EFFECT_MAX_ID,

        SEL_JOURNAL_ENCOUNTER,
        SEL_JOURNAL_ENCOUNTER_MAX_ID,
        SEL_JOURNAL_ENCOUNTER_LOCALE,

        SEL_JOURNAL_ENCOUNTER_SECTION,
        SEL_JOURNAL_ENCOUNTER_SECTION_MAX_ID,
        SEL_JOURNAL_ENCOUNTER_SECTION_LOCALE,

        SEL_JOURNAL_INSTANCE,
        SEL_JOURNAL_INSTANCE_MAX_ID,
        SEL_JOURNAL_INSTANCE_LOCALE,

        SEL_JOURNAL_TIER,
        SEL_JOURNAL_TIER_MAX_ID,
        ...
        SEL_KEYSTONE_AFFIX,
        SEL_KEYSTONE_AFFIX_MAX_ID,
        SEL_KEYSTONE_AFFIX_LOCALE,

        SEL_LANGUAGE_WORDS,
        SEL_LANGUAGE_WORDS_MAX_ID,

        SEL_LANGUAGES,
        SEL_LANGUAGES_MAX_ID,
        SEL_LANGUAGES_LOCALE,

        SEL_LFG_DUNGEONS,
        SEL_LFG_DUNGEONS_MAX_ID,
        ...
        SEL_LIQUID_TYPE,
        SEL_LIQUID_TYPE_MAX_ID,

        SEL_LOCK,
        SEL_LOCK_MAX_ID,

        SEL_MAIL_TEMPLATE,
        SEL_MAIL_TEMPLATE_MAX_ID,
        ...
        SEL_MAP_CHALLENGE_MODE_MAX_ID,
        SEL_MAP_CHALLENGE_MODE_LOCALE,

        SEL_MAP_DIFFICULTY,
        SEL_MAP_DIFFICULTY_MAX_ID,
        SEL_MAP_DIFFICULTY_LOCALE,

        SEL_MAP_DIFFICULTY_X_CONDITION,
        SEL_MAP_DIFFICULTY_X_CONDITION_MAX_ID,
        SEL_MAP_DIFFICULTY_X_CONDITION_LOCALE,

        SEL_MAW_POWER,
        SEL_MAW_POWER_MAX_ID,

        SEL_MODIFIER_TREE,
        SEL_MODIFIER_TREE_MAX_ID,
        ...
        SEL_MOUNT_CAPABILITY_MAX_ID,

        SEL_MOUNT_TYPE_X_CAPABILITY,
        SEL_MOUNT_TYPE_X_CAPABILITY_MAX_ID,

        SEL_MOUNT_X_DISPLAY,
        SEL_MOUNT_X_DISPLAY_MAX_ID,

        SEL_MOVIE,
        SEL_MOVIE_MAX_ID,

        SEL_MYTHIC_PLUS_SEASON,
        SEL_MYTHIC_PLUS_SEASON_MAX_ID,

        SEL_NAME_GEN,
        SEL_NAME_GEN_MAX_ID,

        SEL_NAMES_PROFANITY,
        SEL_NAMES_PROFANITY_MAX_ID,

        SEL_NAMES_RESERVED,
        SEL_NAMES_RESERVED_MAX_ID,

        SEL_NAMES_RESERVED_LOCALE,
        SEL_NAMES_RESERVED_LOCALE_MAX_ID,

        SEL_NUM_TALENTS_AT_LEVEL,
        SEL_NUM_TALENTS_AT_LEVEL_MAX_ID,

        SEL_OVERRIDE_SPELL_DATA,
        SEL_OVERRIDE_SPELL_DATA_MAX_ID,

        SEL_PARAGON_REPUTATION,
        SEL_PARAGON_REPUTATION_MAX_ID,

        SEL_PHASE,
        SEL_PHASE_MAX_ID,

        SEL_PHASE_X_PHASE_GROUP,
        SEL_PHASE_X_PHASE_GROUP_MAX_ID,

        SEL_PLAYER_CONDITION,
        SEL_PLAYER_CONDITION_MAX_ID,
        SEL_PLAYER_CONDITION_LOCALE,

        SEL_POWER_DISPLAY,
        SEL_POWER_DISPLAY_MAX_ID,

        SEL_POWER_TYPE,
        SEL_POWER_TYPE_MAX_ID,

        SEL_PRESTIGE_LEVEL_INFO,
        SEL_PRESTIGE_LEVEL_INFO_MAX_ID,
        SEL_PRESTIGE_LEVEL_INFO_LOCALE,

        SEL_PVP_DIFFICULTY,
        SEL_PVP_DIFFICULTY_MAX_ID,
        ...
        SEL_PVP_SEASON,
        SEL_PVP_SEASON_MAX_ID,

        SEL_PVP_TALENT,
        SEL_PVP_TALENT_MAX_ID,
        SEL_PVP_TALENT_LOCALE,

        SEL_PVP_TALENT_CATEGORY,
        SEL_PVP_TALENT_CATEGORY_MAX_ID,

        SEL_PVP_TALENT_SLOT_UNLOCK,
        SEL_PVP_TALENT_SLOT_UNLOCK_MAX_ID,
        ...
        SEL_QUEST_FACTION_REWARD_MAX_ID,

        SEL_QUEST_INFO,
        SEL_QUEST_INFO_MAX_ID,
        SEL_QUEST_INFO_LOCALE,

        SEL_QUEST_LINE_X_QUEST,
        SEL_QUEST_LINE_X_QUEST_MAX_ID,

        SEL_QUEST_MONEY_REWARD,
        SEL_QUEST_MONEY_REWARD_MAX_ID,

        SEL_QUEST_PACKAGE_ITEM,
        SEL_QUEST_PACKAGE_ITEM_MAX_ID,

        SEL_QUEST_SORT,
        SEL_QUEST_SORT_MAX_ID,
        ...
        SEL_RAND_PROP_POINTS_MAX_ID,

        SEL_REWARD_PACK,
        SEL_REWARD_PACK_MAX_ID,

        SEL_REWARD_PACK_X_CURRENCY_TYPE,
        SEL_REWARD_PACK_X_CURRENCY_TYPE_MAX_ID,

        SEL_REWARD_PACK_X_ITEM,
        SEL_REWARD_PACK_X_ITEM_MAX_ID,
        ...
        SEL_SCENARIO_STEP,
        SEL_SCENARIO_STEP_MAX_ID,
        SEL_SCENARIO_STEP_LOCALE,

        SEL_SCENE_SCRIPT,
        SEL_SCENE_SCRIPT_MAX_ID,

        SEL_SCENE_SCRIPT_GLOBAL_TEXT,
        SEL_SCENE_SCRIPT_GLOBAL_TEXT_MAX_ID,

        SEL_SCENE_SCRIPT_PACKAGE,
        SEL_SCENE_SCRIPT_PACKAGE_MAX_ID,

        SEL_SCENE_SCRIPT_TEXT,
        SEL_SCENE_SCRIPT_TEXT_MAX_ID,

        SEL_SERVER_MESSAGES,
        SEL_SERVER_MESSAGES_MAX_ID,
        SEL_SERVER_MESSAGES_LOCALE,

        SEL_SKILL_LINE,
        SEL_SKILL_LINE_MAX_ID,
        SEL_SKILL_LINE_LOCALE,

        SEL_SKILL_LINE_ABILITY,
        SEL_SKILL_LINE_ABILITY_MAX_ID,
        SEL_SKILL_LINE_ABILITY_LOCALE,

        SEL_SKILL_LINE_X_TRAIT_TREE,
        SEL_SKILL_LINE_X_TRAIT_TREE_MAX_ID,

        SEL_SKILL_RACE_CLASS_INFO,
        SEL_SKILL_RACE_CLASS_INFO_MAX_ID,

        SEL_SOULBIND_CONDUIT_RANK,
        SEL_SOULBIND_CONDUIT_RANK_MAX_ID,

        SEL_SOUND_KIT,
        SEL_SOUND_KIT_MAX_ID,

        SEL_SPECIALIZATION_SPELLS,
        SEL_SPECIALIZATION_SPELLS_MAX_ID,
        SEL_SPECIALIZATION_SPELLS_LOCALE,

        SEL_SPEC_SET_MEMBER,
        SEL_SPEC_SET_MEMBER_MAX_ID,

        SEL_SPELL_AURA_OPTIONS,
        SEL_SPELL_AURA_OPTIONS_MAX_ID,

        SEL_SPELL_AURA_RESTRICTIONS,
        SEL_SPELL_AURA_RESTRICTIONS_MAX_ID,

        SEL_SPELL_CAST_TIMES,
        SEL_SPELL_CAST_TIMES_MAX_ID,

        SEL_SPELL_CASTING_REQUIREMENTS,
        SEL_SPELL_CASTING_REQUIREMENTS_MAX_ID,

        SEL_SPELL_CATEGORIES,
        SEL_SPELL_CATEGORIES_MAX_ID,

        SEL_SPELL_CATEGORY,
        SEL_SPELL_CATEGORY_MAX_ID,
        SEL_SPELL_CATEGORY_LOCALE,

        SEL_SPELL_CLASS_OPTIONS,
        SEL_SPELL_CLASS_OPTIONS_MAX_ID,

        SEL_SPELL_COOLDOWNS,
        SEL_SPELL_COOLDOWNS_MAX_ID,

        SEL_SPELL_DURATION,
        SEL_SPELL_DURATION_MAX_ID,

        SEL_SPELL_EFFECT,
        SEL_SPELL_EFFECT_MAX_ID,

        SEL_SPELL_EQUIPPED_ITEMS,
        SEL_SPELL_EQUIPPED_ITEMS_MAX_ID,

        SEL_SPELL_FOCUS_OBJECT,
        SEL_SPELL_FOCUS_OBJECT_MAX_ID,
        SEL_SPELL_FOCUS_OBJECT_LOCALE,

        SEL_SPELL_INTERRUPTS,
        SEL_SPELL_INTERRUPTS_MAX_ID,

        SEL_SPELL_ITEM_ENCHANTMENT,
        SEL_SPELL_ITEM_ENCHANTMENT_MAX_ID,
        SEL_SPELL_ITEM_ENCHANTMENT_LOCALE,

        SEL_SPELL_ITEM_ENCHANTMENT_CONDITION,
        SEL_SPELL_ITEM_ENCHANTMENT_CONDITION_MAX_ID,

        SEL_SPELL_KEYBOUND_OVERRIDE,
        SEL_SPELL_KEYBOUND_OVERRIDE_MAX_ID,

        SEL_SPELL_LABEL,
        SEL_SPELL_LABEL_MAX_ID,

        SEL_SPELL_LEARN_SPELL,
        SEL_SPELL_LEARN_SPELL_MAX_ID,

        SEL_SPELL_LEVELS,
        SEL_SPELL_LEVELS_MAX_ID,

        SEL_SPELL_MISC,
        SEL_SPELL_MISC_MAX_ID,

        SEL_SPELL_NAME,
        SEL_SPELL_NAME_MAX_ID,
        SEL_SPELL_NAME_LOCALE,

        SEL_SPELL_POWER,
        SEL_SPELL_POWER_MAX_ID,

        SEL_SPELL_POWER_DIFFICULTY,
        SEL_SPELL_POWER_DIFFICULTY_MAX_ID,

        SEL_SPELL_PROCS_PER_MINUTE,
        SEL_SPELL_PROCS_PER_MINUTE_MAX_ID,

        SEL_SPELL_PROCS_PER_MINUTE_MOD,
        SEL_SPELL_PROCS_PER_MINUTE_MOD_MAX_ID,

        SEL_SPELL_RADIUS,
        SEL_SPELL_RADIUS_MAX_ID,

        SEL_SPELL_RANGE,
        SEL_SPELL_RANGE_MAX_ID,
        SEL_SPELL_RANGE_LOCALE,

        SEL_SPELL_REAGENTS,
        SEL_SPELL_REAGENTS_MAX_ID,

        SEL_SPELL_REAGENTS_CURRENCY,
        SEL_SPELL_REAGENTS_CURRENCY_MAX_ID,

        SEL_SPELL_SCALING,
        SEL_SPELL_SCALING_MAX_ID,

        SEL_SPELL_SHAPESHIFT,
        SEL_SPELL_SHAPESHIFT_MAX_ID,

        SEL_SPELL_SHAPESHIFT_FORM,
        SEL_SPELL_SHAPESHIFT_FORM_MAX_ID,
        SEL_SPELL_SHAPESHIFT_FORM_LOCALE,

        SEL_SPELL_TARGET_RESTRICTIONS,
        SEL_SPELL_TARGET_RESTRICTIONS_MAX_ID,

        SEL_SPELL_TOTEMS,
        SEL_SPELL_TOTEMS_MAX_ID,

        SEL_SPELL_VISUAL,
        SEL_SPELL_VISUAL_MAX_ID,

        SEL_SPELL_VISUAL_EFFECT_NAME,
        SEL_SPELL_VISUAL_EFFECT_NAME_MAX_ID,

        SEL_SPELL_VISUAL_MISSILE,
        SEL_SPELL_VISUAL_MISSILE_MAX_ID,

        SEL_SPELL_VISUAL_KIT,
        SEL_SPELL_VISUAL_KIT_MAX_ID,

        SEL_SPELL_X_SPELL_VISUAL,
        SEL_SPELL_X_SPELL_VISUAL_MAX_ID,

        SEL_SUMMON_PROPERTIES,
        SEL_SUMMON_PROPERTIES_MAX_ID,
        ...
        SEL_TAXI_NODES,
        SEL_TAXI_NODES_MAX_ID,
        SEL_TAXI_NODES_LOCALE,

        SEL_TAXI_PATH,
        SEL_TAXI_PATH_MAX_ID,

        SEL_TAXI_PATH_NODE,
        SEL_TAXI_PATH_NODE_MAX_ID,

        SEL_TOTEM_CATEGORY,
        SEL_TOTEM_CATEGORY_MAX_ID,
        ...
        SEL_TRANSMOG_HOLIDAY_MAX_ID,

        SEL_TRAIT_COND,
        SEL_TRAIT_COND_MAX_ID,

        SEL_TRAIT_COST,
        SEL_TRAIT_COST_MAX_ID,

        SEL_TRAIT_CURRENCY,
        SEL_TRAIT_CURRENCY_MAX_ID,

        SEL_TRAIT_CURRENCY_SOURCE,
        SEL_TRAIT_CURRENCY_SOURCE_MAX_ID,
        SEL_TRAIT_CURRENCY_SOURCE_LOCALE,

        SEL_TRAIT_DEFINITION,
        SEL_TRAIT_DEFINITION_MAX_ID,
        SEL_TRAIT_DEFINITION_LOCALE,

        SEL_TRAIT_DEFINITION_EFFECT_POINTS,
        SEL_TRAIT_DEFINITION_EFFECT_POINTS_MAX_ID,

        SEL_TRAIT_EDGE,
        SEL_TRAIT_EDGE_MAX_ID,

        SEL_TRAIT_NODE,
        SEL_TRAIT_NODE_MAX_ID,

        SEL_TRAIT_NODE_ENTRY,
        SEL_TRAIT_NODE_ENTRY_MAX_ID,

        SEL_TRAIT_NODE_ENTRY_X_TRAIT_COND,
        SEL_TRAIT_NODE_ENTRY_X_TRAIT_COND_MAX_ID,

        SEL_TRAIT_NODE_ENTRY_X_TRAIT_COST,
        SEL_TRAIT_NODE_ENTRY_X_TRAIT_COST_MAX_ID,

        SEL_TRAIT_NODE_GROUP,
        SEL_TRAIT_NODE_GROUP_MAX_ID,

        SEL_TRAIT_NODE_GROUP_X_TRAIT_COND,
        SEL_TRAIT_NODE_GROUP_X_TRAIT_COND_MAX_ID,

        SEL_TRAIT_NODE_GROUP_X_TRAIT_COST,
        SEL_TRAIT_NODE_GROUP_X_TRAIT_COST_MAX_ID,

        SEL_TRAIT_NODE_GROUP_X_TRAIT_NODE,
        SEL_TRAIT_NODE_GROUP_X_TRAIT_NODE_MAX_ID,

        SEL_TRAIT_NODE_X_TRAIT_COND,
        SEL_TRAIT_NODE_X_TRAIT_COND_MAX_ID,

        SEL_TRAIT_NODE_X_TRAIT_COST,
        SEL_TRAIT_NODE_X_TRAIT_COST_MAX_ID,

        SEL_TRAIT_NODE_X_TRAIT_NODE_ENTRY,
        SEL_TRAIT_NODE_X_TRAIT_NODE_ENTRY_MAX_ID,

        SEL_TRAIT_TREE,
        SEL_TRAIT_TREE_MAX_ID,

        SEL_TRAIT_TREE_LOADOUT,
        SEL_TRAIT_TREE_LOADOUT_MAX_ID,

        SEL_TRAIT_TREE_LOADOUT_ENTRY,
        SEL_TRAIT_TREE_LOADOUT_ENTRY_MAX_ID,

        SEL_TRAIT_TREE_X_TRAIT_COST,
        SEL_TRAIT_TREE_X_TRAIT_COST_MAX_ID,

        SEL_TRAIT_TREE_X_TRAIT_CURRENCY,
        SEL_TRAIT_TREE_X_TRAIT_CURRENCY_MAX_ID,

        SEL_TRANSMOG_ILLUSION,
        SEL_TRANSMOG_ILLUSION_MAX_ID,

        SEL_TRANSMOG_SET,
        SEL_TRANSMOG_SET_MAX_ID,
        SEL_TRANSMOG_SET_LOCALE,

        SEL_TRANSMOG_SET_GROUP,
        SEL_TRANSMOG_SET_GROUP_MAX_ID,
        SEL_TRANSMOG_SET_GROUP_LOCALE,

        SEL_TRANSMOG_SET_ITEM,
        SEL_TRANSMOG_SET_ITEM_MAX_ID,

        SEL_TRANSPORT_ANIMATION,
        SEL_TRANSPORT_ANIMATION_MAX_ID,

        SEL_TRANSPORT_ROTATION,
        SEL_TRANSPORT_ROTATION_MAX_ID,
        ...
        SEL_UI_MAP_ASSIGNMENT_MAX_ID,

        SEL_UI_MAP_LINK,
        SEL_UI_MAP_LINK_MAX_ID,

        SEL_UI_MAP_X_MAP_ART,
        SEL_UI_MAP_X_MAP_ART_MAX_ID,

        SEL_UI_SPLASH_SCREEN,
        SEL_UI_SPLASH_SCREEN_MAX_ID,
        SEL_UI_SPLASH_SCREEN_LOCALE,

        SEL_UNIT_CONDITION,
        SEL_UNIT_CONDITION_MAX_ID,

        SEL_UNIT_POWER_BAR,
        SEL_UNIT_POWER_BAR_MAX_ID,
        ...
        SEL_VEHICLE_SEAT,
        SEL_VEHICLE_SEAT_MAX_ID,

        SEL_WMO_AREA_TABLE,
        SEL_WMO_AREA_TABLE_MAX_ID,
        SEL_WMO_AREA_TABLE_LOCALE,

        SEL_WORLD_EFFECT,
        SEL_WORLD_EFFECT_MAX_ID,

        SEL_WORLD_MAP_OVERLAY,
        SEL_WORLD_MAP_OVERLAY_MAX_ID,

        SEL_WORLD_STATE_EXPRESSION,
        SEL_WORLD_STATE_EXPRESSION_MAX_ID,
